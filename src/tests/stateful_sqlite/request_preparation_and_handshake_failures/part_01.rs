...
async fn seed_request_compression_attempt(
    ...
    insert_pool_upstream_request_attempt_with_scope(
        ...
        PoolAttemptInsertRequest {
            ...
            first_byte_latency_ms: Some(24.0),
            stream_latency_ms: Some(36.0),
            upstream_request_id: Some("req_compression_obs"),
            upstream_request_compression_algorithm: Some("gzip"),
            upstream_request_compression_mode: Some("recompressed"),
            upstream_request_logical_body_bytes: Some(128),
            upstream_request_transmitted_body_bytes: Some(64),
            upstream_request_header_bytes_approx: Some(24),
            upstream_response_body_bytes: Some(512),
            upstream_response_header_bytes_approx: Some(48),
            ..PoolAttemptInsertRequest::default()
        },
    )
    .await
...
async fn seed_budget_terminal_attempt(
    ...
    insert_pool_upstream_request_attempt_with_scope(
        ...
        PoolAttemptInsertRequest {
            ...
            started_at: Some(occurred_at),
            finished_at: Some(occurred_at),
            status: POOL_UPSTREAM_REQUEST_ATTEMPT_STATUS_BUDGET_EXHAUSTED_FINAL,
            phase: Some(POOL_UPSTREAM_REQUEST_ATTEMPT_PHASE_COMPLETED),
            ..PoolAttemptInsertRequest::default()
        },
    )
