...
pub(crate) fn build_pool_routes(router: Router<Arc<AppState>>) -> Router<Arc<AppState>> {
    build_pool_oauth_routes(build_pool_account_routes(router))
}

fn build_pool_account_routes(router: Router<Arc<AppState>>) -> Router<Arc<AppState>> {
    router
        .route(
...
fn build_pool_oauth_routes(router: Router<Arc<AppState>>) -> Router<Arc<AppState>> {
    router
        .route(
