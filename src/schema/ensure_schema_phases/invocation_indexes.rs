...
pub(super) async fn ensure_schema_invocation_indexes(pool: &Pool<Sqlite>) -> Result<()> {
    ensure_invocation_time_indexes(pool).await?;
    ensure_invocation_prompt_and_identity_indexes(pool).await?;
    ensure_invocation_filter_indexes(pool).await?;
    ensure_invocation_pending_indexes(pool).await?;
    Ok(())
}

async fn ensure_invocation_time_indexes(pool: &Pool<Sqlite>) -> Result<()> {
...
async fn ensure_invocation_prompt_and_identity_indexes(pool: &Pool<Sqlite>) -> Result<()> {
    sqlx::query(
        r#"
...
async fn ensure_invocation_filter_indexes(pool: &Pool<Sqlite>) -> Result<()> {
    ensure_invocation_sticky_filter_index(pool).await?;
    ensure_invocation_text_filter_indexes(pool).await?;
    Ok(())
}

async fn ensure_invocation_sticky_filter_index(pool: &Pool<Sqlite>) -> Result<()> {
...
async fn ensure_invocation_text_filter_indexes(pool: &Pool<Sqlite>) -> Result<()> {
...
async fn ensure_invocation_pending_indexes(pool: &Pool<Sqlite>) -> Result<()> {
    sqlx::query(
        r#"
