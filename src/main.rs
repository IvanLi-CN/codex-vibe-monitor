...
async fn send_pool_request_with_failover(
    ...
    let pre_first_byte_timeout = pool_upstream_first_chunk_timeout(
        &runtime_timeouts,
        original_uri,
        &method,
        handshake_timeout,
...
async fn proxy_openai_v1_via_pool(
    ...
    let handshake_timeout =
        proxy_upstream_handshake_timeout_for_capture_target(&runtime_timeouts, capture_target);
    let pre_first_byte_timeout = pool_upstream_first_chunk_timeout(
        &runtime_timeouts,
        original_uri,
        &method,
...
async fn proxy_openai_v1_inner(
    ...
    let handshake_timeout =
        proxy_upstream_handshake_timeout_for_capture_target(&runtime_timeouts, None);
...
async fn proxy_openai_v1_capture_target(
    ...
    let handshake_timeout = proxy_upstream_handshake_timeout_for_capture_target(
        &runtime_timeouts,
        Some(capture_target),
    );
    let (
...
fn proxy_upstream_handshake_timeout_for_capture_target(
    ...
    if capture_target.is_some_and(ProxyCaptureTarget::uses_compact_upstream_timeout) {
        timeouts.compact_upstream_handshake_timeout
    } else {
        timeouts.upstream_handshake_timeout
    }
}
...
impl AppConfig {
    fn proxy_upstream_handshake_timeout(
        ...
        let timeouts = pool_routing_timeouts_from_config(self);
        proxy_upstream_handshake_timeout_for_capture_target(&timeouts, capture_target)
    }
