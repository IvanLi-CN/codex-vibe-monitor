...
const allRoutes: RouteCase[] = [
  ...
  { path: '/#/account-pool/upstream-accounts/new?mode=apiKey', expectedPath: '/account-pool/upstream-accounts/new' },
  { path: '/#/account-pool/maintenance-records', expectedPath: '/account-pool/maintenance-records' },
...
test.describe('Web Demo runtime', () => {
  ...
  test('injects a mock realtime event and keeps it in the Inspector action log', async ({ page }) => {
