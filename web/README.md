...
- 平台边界：Android Chrome/WebAPK 与支持 manifest 图标更新的 Chromium Desktop 会保留原安装身份并收敛到新图标；已有 iOS/iPadOS Web Clip 或不支持该更新的浏览器无法被网站强制迁移，产品 App 不提供 Apple touch fallback，也不把重装作为常规更新方案。
