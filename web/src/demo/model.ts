  ...
  return [
    {
      ...
      updatedAt: DEMO_NOW,
      primaryWindow: { usedPercent: 38, usedText: '38%', limitText: 'weekly', windowDurationMins: 10080 },
      secondaryWindow: { usedPercent: 12, usedText: '12%', limitText: '5-hour', windowDurationMins: 300 },
    },
    {
      id: 102,
      kind: 'api_key',
      ...
      updatedAt: DEMO_NOW,
      primaryWindow: { usedPercent: 82, usedText: '82%', limitText: 'monthly', windowDurationMins: 43200 },
...
function createState(scene: DemoScene): DemoState {
  return {
    ...
    externalApiKeys: [
      { id: 41, name: 'Demo integration', status: 'active', prefix: 'cvm_demo', lastUsedAt: '2026-07-10T09:00:00Z', createdAt: '2026-07-01T02:00:00Z', updatedAt: DEMO_NOW },
    ],
