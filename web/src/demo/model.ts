...
function createSettings() {
  return {
    proxy: {
      ...
      enabledModels: ["gpt-6-astra", "gpt-6-sol", "gpt-6-luna", "gpt-5.6-sol", "gpt-5.6-terra"],
    },
    forwardProxy: {
      proxyUrls: [
    ...
    externalApiKeys: [
      {
        ...
        status: "active",
        prefix: "cvm_prod",
        lastUsedAt: "2026-07-10T09:24:00Z",
      ...
      },
      {
        ...
        status: "active",
        prefix: "cvm_ci",
        lastUsedAt: "2026-07-10T08:42:00Z",
      ...
      {
        id: 46,
        name: "Mobile QA console",
        status: "active",
        prefix: "cvm_mobile",
        lastUsedAt: "2026-07-10T09:18:00Z",
