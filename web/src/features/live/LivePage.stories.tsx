...
import { parityLiveStats } from "../forward-proxy/storybookForwardProxyNodeHealth";
    ...
    nodes: [
      {
        ...
        last24h: Array.from({ length: 24 }, (_, index) => ({
          bucketStart: new Date(
            Date.parse("2026-04-05T12:00:00.000Z") + index * 3600_000,
          ).toISOString(),
          bucketEnd: new Date(
            Date.parse("2026-04-05T13:00:00.000Z") + index * 3600_000,
          ).toISOString(),
  ...
  return {
    ...
    conversations: [
      createConversation("pc-live-1", [
        ...
        createPreview({
          id: 102,
          invokeId: "pc-live-1-b",
          occurredAt: "2026-04-06T11:56:00.000Z",
          status: "success",
          model: "gpt-5.4-mini",
        }),
      ]),
      createConversation("pc-live-2", [
        createPreview({
          id: 103,
          invokeId: "pc-live-2-a",
          occurredAt: "2026-04-06T11:58:00.000Z",
          status: "success",
        }),
        createPreview({
          id: 104,
          invokeId: "pc-live-2-b",
          occurredAt: "2026-04-06T11:52:00.000Z",
          status: "http_502",
  ...
  const invocations = {
    records: [
      ...
      createInvocation({
        id: 2,
        invokeId: "live-2",
        occurredAt: "2026-04-06T11:59:00.000Z",
      ...
      createInvocation({
        id: 4,
        invokeId: "live-4",
        occurredAt: "2026-04-06T11:57:00.000Z",
...
const meta = {
  ...
  decorators: [
    (Story, context) => {
      const scenario = ((context.parameters as LiveStoryParameters).scenario ??
        "default") as LiveScenario;
      return (
        <I18nProvider>
