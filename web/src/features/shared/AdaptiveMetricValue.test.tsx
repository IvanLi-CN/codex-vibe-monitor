...
it("uses the account-card duration ladder without changing the default duration contract", () => {
  expect(
    buildAdaptiveDurationTextSpec(9_300, "en-US", { presentation: "account-stat-card" }).fullValue,
  ).toBe("9.3 s");
  expect(
    buildAdaptiveDurationTextSpec(65_000, "en-US", { presentation: "account-stat-card" }).fullValue,
  ).toBe("1.08 min");
  expect(
