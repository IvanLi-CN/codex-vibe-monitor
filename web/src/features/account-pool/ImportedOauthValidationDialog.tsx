...
export function ImportedOauthValidationDialog({
  ...
  return (
    ...
    >
      <DialogContent className="flex h-[calc(100dvh-0.75rem)] max-h-[calc(100dvh-0.75rem)] max-w-none flex-col overflow-hidden p-0 min-[769px]:h-[min(92vh,56rem)] min-[769px]:max-h-[min(92vh,56rem)] min-[769px]:w-[min(96vw,92rem)]">
        <div className="grid h-full min-h-0 grid-rows-[auto,minmax(0,1fr),auto]">
          <DialogHeader className="border-b border-base-300 bg-[linear-gradient(180deg,rgba(15,23,42,0.04),transparent)] px-5 pb-4 pt-4 min-[769px]:px-6 min-[769px]:pb-5 min-[769px]:pt-5">
          ...
          <div className="grid h-full min-h-0 grid-rows-[auto,minmax(0,1fr)] overflow-hidden px-5 py-5 min-[769px]:px-6">
          ...
          <DialogFooter className="border-t border-base-300 bg-base-100/94 px-5 pb-[max(env(safe-area-inset-bottom),1rem)] pt-4 backdrop-blur min-[769px]:px-6 min-[769px]:py-4">
