...
export function GroupAccountRoutingRuleDialog({
  ...
  return (
    ...
    >
      <DialogContent className="flex max-h-[calc(100dvh-0.75rem)] max-w-none flex-col overflow-hidden p-0 min-[1024px]:max-h-[min(90vh,calc(100vh-2rem))] min-[1024px]:w-[min(48rem,calc(100vw-2rem))]">
        <div className="shrink-0 border-b border-base-300/80 px-5 py-4 min-[1024px]:px-6 min-[1024px]:py-5">
          <DialogHeader>
        ...
        <div className="shrink-0 border-t border-base-300/80 bg-base-100/94 px-5 pb-[max(env(safe-area-inset-bottom),1rem)] pt-4 backdrop-blur min-[1024px]:px-6 min-[1024px]:py-4">
          <DialogFooter>
            <Button
              type="button"
              variant="ghost"
