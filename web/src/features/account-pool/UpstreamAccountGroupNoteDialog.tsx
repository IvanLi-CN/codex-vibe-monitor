...
export function UpstreamAccountGroupNoteDialog({
  ...
  return (
    ...
    >
      <DialogContent
        container={container}
        className="flex max-h-[calc(100dvh-0.75rem)] flex-col overflow-hidden border-base-300 bg-base-100 p-0 min-[769px]:max-h-[calc(100dvh-2rem)] min-[769px]:w-[min(44rem,calc(100vw-4rem))] min-[769px]:max-w-[44rem]"
      >
        ...
        <DialogFooter className="border-t border-base-300/80 bg-base-100/94 px-5 pb-[max(env(safe-area-inset-bottom),1rem)] pt-4 backdrop-blur min-[769px]:items-end min-[769px]:justify-between min-[769px]:px-6 min-[769px]:py-5">
