...
const { fetchExternalApiKeys, createExternalApiKey, rotateExternalApiKey, disableExternalApiKey } =
  apiMocks;
...
describe("ExternalApiKeysSettingsCard", () => {
  it("renders list and supports create, rotate, and disable flows", async () => {
    ...
    await flush();
    const confirmCreateButton = Array.from(dialog?.querySelectorAll("button") ?? []).find(
