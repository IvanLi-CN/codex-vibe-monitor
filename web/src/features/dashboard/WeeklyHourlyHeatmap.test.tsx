...
describe("WeeklyHourlyHeatmap", () => {
  it("keeps the standalone card shell and header by default", () => {
    ...
    expect(
      host?.querySelector('section.surface-panel[data-testid="weekly-hourly-heatmap"]'),
    ).not.toBeNull();
  ...
  it("supports embedded controlled rendering without the outer panel shell", () => {
    ...
    render(<WeeklyHourlyHeatmap metric="totalCost" showHeader={false} showSurface={false} />);
