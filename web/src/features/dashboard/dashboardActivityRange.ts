...
function isDashboardWorkspaceView(value: string | null): value is DashboardWorkspaceView {
...
export function readPersistedDashboardWorkspaceView(storageKey: string): DashboardWorkspaceView {
...
export function persistDashboardWorkspaceView(storageKey: string, view: DashboardWorkspaceView) {
  if (typeof window === "undefined") return;
  try {
