  ...
  const accounts: UpstreamAccountActivityAccount[] = [
    {
      ...
      usageBreakdown: {
        ...
        costs: { input: 3.8, cacheWrite: 5.9, cacheRead: 0.62, output: 13.2, reasoning: 0.8, unknown: 0 },
        models: [],
      },
      cacheHitRate: 0.927,
      tokensPerMinute: 610,
    ...
    },
    {
      ...
      usageBreakdown: {
        ...
        costs: { input: 2.6, cacheWrite: 4.2, cacheRead: 0.45, output: 10.7, reasoning: 0.59, unknown: 0 },
        models: [],
      },
      cacheHitRate: 0.914,
      tokensPerMinute: 490,
