...
function buildGeometry(
  ...
  const maxCumulative = Math.max(
    maxCumulativeTokens,
    ...segments.map((segment) => segment.cumulativeTokens),
    1,
  );
  ...
  const jumps = positioned.slice(1).map((segment, index) => ({
    x: segment.x1,
  ...
  return {
    ...
    rows: [
      ...
      },
      {
        ...
        value: numberFormatter.format(point.requestTokens),
        tone: "accent",
      },
      {
              ...
              >
                ...
                <dl className="grid grid-cols-2 gap-x-3 gap-y-2 text-xs">
                  ...
                  <div>
                    ...
                    <dd>
                      {Number.isFinite(conversation.totalCost)
                        ? currencyFormatter.format(conversation.totalCost)
                        : FALLBACK_CELL}
                    </dd>
                  </div>
                  <div>
                ...
                <div className="space-y-1">
                  ...
                  <ConversationSparkline
                    ...
                    ariaLabel={`${conversationKey} ${chartAriaLabel}`}
              ...
              return (
                ...
                >
                  ...
                  <td className="px-2 py-2 align-middle sm:px-3 sm:py-3">
                    {createdAtLabel || FALLBACK_CELL}
                  </td>
                  <td className="px-2 py-2 align-middle sm:px-3 sm:py-3">
                    {lastActivityLabel || FALLBACK_CELL}
                  </td>
                  <td className="px-2 py-2 align-middle sm:px-3 sm:py-3">
                    <ConversationSparkline
                      conversation={conversation}
