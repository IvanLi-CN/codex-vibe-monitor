...
export default function SystemStatusPage() {
  ...
  const cards = useMemo(() => {
    ...
    return [
      ...
      {
        key: 'unarchivedCount',
        title: t('system.status.cards.unarchivedBodiesCount'),
        value: status.unarchivedBodies.count.toLocaleString(),
        hint: t('system.status.cards.unarchivedBodiesCountHint'),
      },
      {
        key: 'unarchivedBytes',
        title: t('system.status.cards.unarchivedBodiesBytes'),
        value: formatBytes(status.unarchivedBodies.bytes),
        hint: t('system.status.cards.unarchivedBodiesBytesHint'),
      },
      {
        key: 'database',
