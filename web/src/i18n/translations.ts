...
const baseTranslations = {
  en: {
    ...
    "system.status.definition":
      "Non-success count includes every recorded invocation whose status is not `success`, including failed and unfinished terminal outcomes. Raw payload bytes reflect on-disk file sizes.",
    ...
    "system.status.cards.archivedBodiesBytesHint": "Current on-disk archive directory footprint.",
    ...
    "system.status.cards.rawBodiesBytes": "Raw payload size",
    "system.status.cards.rawBodiesBytesHint": "Actual on-disk bytes for unique request + response raw payload files.",
    ...
    "system.status.cards.requestRawBodiesBytes": "Request raw payload size",
    "system.status.cards.requestRawBodiesBytesHint": "Actual on-disk bytes for unique request-side raw payload files.",
    ...
    "system.status.cards.responseRawBodiesBytes": "Response raw payload size",
    "system.status.cards.responseRawBodiesBytesHint": "Actual on-disk bytes for unique response-side raw payload files.",
  ...
  zh: {
    ...
    "system.status.definition": "非成功数按所有 `status != success` 的调用记录统计，包含失败和未完成的终态记录。raw payload 字节数按磁盘上实际文件大小统计。",
    ...
    "system.status.cards.archivedBodiesBytesHint": "当前 archive 目录在磁盘上的体积。",
    ...
    "system.status.cards.rawBodiesBytes": "raw payload 体积",
    "system.status.cards.rawBodiesBytesHint": "request + response raw payload 的磁盘实测字节数。",
    ...
    "system.status.cards.requestRawBodiesBytes": "request raw payload 体积",
    "system.status.cards.requestRawBodiesBytesHint": "request 侧 raw payload 的磁盘实测字节数。",
    ...
    "system.status.cards.responseRawBodiesBytes": "response raw payload 体积",
    "system.status.cards.responseRawBodiesBytesHint": "response 侧 raw payload 的磁盘实测字节数。",
