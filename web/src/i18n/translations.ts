...
const baseTranslations = {
  en: {
    ...
    'live.proxy.description': 'Per-node window stats (success rate / avg latency) and last 24h request volume split by success/failure.',
  ...
  zh: {
    ...
    'live.proxy.description': '按节点展示多窗口统计（成功率 / 平均延迟）与近 24 小时成功/失败请求量。',
