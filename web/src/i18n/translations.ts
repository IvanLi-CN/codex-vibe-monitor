...
const baseTranslations = {
  en: {
    ...
    'accountPool.upstreamAccounts.hints.bridgeUnavailableTitle': 'The fixed OAuth bridge is unavailable',
    'accountPool.upstreamAccounts.hints.bridgeUnavailableBody': 'The built-in OAuth bridge sidecar cannot be reached right now. Check that the ai-openai-oauth-bridge service is running and healthy on the same network.',
    'accountPool.upstreamAccounts.hints.bridgeExchangeTitle': 'This OAuth account could not register with the fixed bridge',
    'accountPool.upstreamAccounts.hints.bridgeExchangeBody': 'The built-in OAuth bridge rejected the refreshed access token exchange. Inspect the bridge logs first; only re-authorize if the upstream refresh grant itself is invalid.',
    'accountPool.upstreamAccounts.hints.bridgeUpstreamTitle': 'The OAuth bridge upstream rejected this request',
    'accountPool.upstreamAccounts.hints.bridgeUpstreamBody': 'The fixed OAuth bridge accepted the account, but its upstream data plane rejected the request. Inspect the bridge-side upstream error before re-authorizing the account.',
  ...
  zh: {
    ...
    'accountPool.upstreamAccounts.hints.bridgeUnavailableTitle': '固定 OAuth bridge 当前不可用',
    'accountPool.upstreamAccounts.hints.bridgeUnavailableBody': '项目内置的 OAuth bridge sidecar 当前不可达。先检查 ai-openai-oauth-bridge 服务是否已在同一网络中启动并通过健康检查。',
    'accountPool.upstreamAccounts.hints.bridgeExchangeTitle': '这个 OAuth 账号无法注册到固定 bridge',
    'accountPool.upstreamAccounts.hints.bridgeExchangeBody': '内置 OAuth bridge 拒绝了这次刷新后 access token 的注册。先查 bridge 日志；只有 refresh grant 本身失效时才需要重新授权。',
    'accountPool.upstreamAccounts.hints.bridgeUpstreamTitle': 'OAuth bridge 的上游拒绝了这次请求',
    'accountPool.upstreamAccounts.hints.bridgeUpstreamBody': '固定 OAuth bridge 已接受这个账号，但它的数据面上游拒绝了请求。先检查 bridge 侧的上游错误，再决定是否需要重新授权。',
