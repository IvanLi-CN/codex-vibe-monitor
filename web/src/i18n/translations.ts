...
const baseTranslations = {
  en: {
    ...
    "system.status.definition":
      "Non-success count includes every recorded invocation whose status is not `success`, including failed and unfinished terminal outcomes.",
    ...
    "system.status.cards.unarchivedBodiesCount": "Unarchived bodies",
    "system.status.cards.unarchivedBodiesCountHint": "Invocation rows that still point to raw response bodies.",
    "system.status.cards.unarchivedBodiesBytes": "Unarchived body size",
    "system.status.cards.unarchivedBodiesBytesHint": "Summed raw response body bytes from live invocation rows.",
  ...
  zh: {
    ...
    "system.status.definition": "非成功数按所有 `status != success` 的调用记录统计，包含失败和未完成的终态记录。",
    ...
    "system.status.cards.unarchivedBodiesCount": "未归档 body 数量",
    "system.status.cards.unarchivedBodiesCountHint": "仍指向原始 response body 的调用记录数。",
    "system.status.cards.unarchivedBodiesBytes": "未归档 body 体积",
    "system.status.cards.unarchivedBodiesBytesHint": "存量调用记录中原始 response body 的累计字节数。",
