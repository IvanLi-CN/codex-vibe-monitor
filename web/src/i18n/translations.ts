...
const baseTranslations = {
  en: {
    ...
    'accountPool.upstreamAccounts.oauth.mailboxHint': 'Generate a temp mailbox here. Clear the field before generating a new one.',
  ...
  zh: {
    ...
    'accountPool.upstreamAccounts.oauth.callbackUrlPlaceholder': 'http://localhost:43210/oauth/callback?code=...&state=...',
    'accountPool.upstreamAccounts.oauth.mailboxHint': '这里会生成临时邮箱；想重新生成时，先把输入框清空。',
