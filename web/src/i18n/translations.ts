...
const baseTranslations = {
  en: {
    ...
    'accountPool.upstreamAccounts.description': 'Add OAuth and API key accounts, then keep their login state and quota snapshots healthy.',
    ...
    'accountPool.upstreamAccounts.createPage.description': 'Use one dedicated screen to create OAuth or API key accounts without squeezing the roster view.',
  ...
  zh: {
    ...
    'accountPool.upstreamAccounts.description': '新增 OAuth 与 API Key 账号，并持续维护登录状态和额度快照。',
    ...
    'accountPool.upstreamAccounts.createPage.description': '把新增 OAuth 和 API Key 账号拆到单独页面，避免挤占账号列表的浏览空间。',
