...
const baseTranslations = {
  en: {
    ...
    "accountPool.upstreamAccounts.healthDetails": "Show diagnostic details",
    ...
    "accountPool.upstreamAccounts.records.title": "Request attempts",
    ...
    "accountPool.upstreamAccounts.records.description":
      "Review the latest request attempts routed to this upstream account.",
    "accountPool.upstreamAccounts.records.limitLabel": "Rows",
    "accountPool.upstreamAccounts.records.limitOption": "{{count}} request attempts",
    "accountPool.upstreamAccounts.records.empty":
      "No request attempts for this upstream account yet.",
    "accountPool.upstreamAccounts.records.loadingMore": "Loading more request attempts...",
    "accountPool.upstreamAccounts.records.loaded": "Loaded {{loaded}} / {{total}} request attempts",
    "accountPool.upstreamAccounts.records.allLoaded": "All {{count}} request attempts loaded",
    "accountPool.upstreamAccounts.records.locating": "Locating the selected request...",
    ...
    "accountPool.upstreamAccounts.records.located":
      "Showing the frozen history window around request {{invokeId}}.",
    "accountPool.upstreamAccounts.records.returnLatest": "Return to latest requests",
    "accountPool.upstreamAccounts.records.locateNotFound":
      "Request {{invokeId}} was not found in request attempts.",
    "accountPool.upstreamAccounts.records.locateFailed": "Could not locate request {{invokeId}}.",
    "accountPool.upstreamAccounts.records.retryLocate": "Retry",
    "accountPool.upstreamAccounts.records.anchoredLoaded":
      "Loaded {{loaded}} of {{total}} request attempts around the selected request",
    ...
    "accountPool.upstreamAccounts.effectiveRule.availableModelsAllowed": "Allowed models",
    ...
    "accountPool.upstreamAccounts.detailTabs.records": "Requests",
    ...
    "accountPool.upstreamAttempts.empty":
      "No request attempts for this account in the past 7 days.",
    "accountPool.upstreamAttempts.description":
      "Request attempts from the primary database for the past 7 days. Each row is one real upstream request attempt.",
    ...
    "accountPool.upstreamAttempts.filters.type": "Type",
    "accountPool.upstreamAttempts.filters.typeAll": "All types",
    "accountPool.upstreamAttempts.filters.model": "Model",
    "accountPool.upstreamAttempts.filters.modelAll": "All models",
    "accountPool.upstreamAttempts.filters.conversation": "Conversation",
    "accountPool.upstreamAttempts.filters.conversationAll": "All conversations",
    "accountPool.upstreamAttempts.filters.conversationUnbound": "Unbound conversation",
    ...
    "accountPool.upstreamAttempts.compressionRatio": "Compression ratio",
    "accountPool.upstreamAttempts.approxUpload": "Approx upload",
    "accountPool.upstreamAttempts.approxDownload": "Approx download",
    ...
    "accountPool.upstreamAttempts.columns.call": "Request ID",
    "accountPool.upstreamAttempts.callShortId": "Call short ID",
    ...
    "accountPool.upstreamAttempts.total": "{{count}} request attempts",
    ...
    "accountPool.upstreamAccounts.modelMappings.title": "Model mapping",
    "accountPool.upstreamAccounts.modelMappings.description":
      "Map a requested model to the literal model name sent to this account.",
    "accountPool.upstreamAccounts.modelMappings.add": "Add mapping",
    "accountPool.upstreamAccounts.modelMappings.sourceModel": "Original model",
    "accountPool.upstreamAccounts.modelMappings.targetModel": "Target model",
    "accountPool.upstreamAccounts.modelMappings.enabled": "Enabled",
    "accountPool.upstreamAccounts.modelMappings.sourcePlaceholder": "Requested model or * pattern",
    "accountPool.upstreamAccounts.modelMappings.targetPlaceholder": "Model name sent upstream",
    "accountPool.upstreamAccounts.modelMappings.noSuggestions": "No suggested models",
    "accountPool.upstreamAccounts.modelMappings.reorder": "Reorder mapping",
    "accountPool.upstreamAccounts.modelMappings.remove": "Remove mapping",
    "accountPool.upstreamAccounts.modelMappings.empty": "No model mappings for this account.",
    "accountPool.upstreamAccounts.modelMappings.validation.empty":
      "Every mapping needs an original and target model.",
    "accountPool.upstreamAccounts.modelMappings.validation.duplicate":
      "Original model rules must be unique, ignoring ASCII letter case.",
    "accountPool.upstreamAccounts.modelMappings.validation.limit":
      "An account can have at most 100 model mappings.",
    "accountPool.upstreamAccounts.modelMappings.count": "{{count}} / 100 mappings",
    "accountPool.upstreamAccounts.modelMappings.save": "Save mappings",
    "accountPool.upstreamAccounts.modelMappings.saving": "Saving...",
    "accountPool.upstreamAccounts.modelMappings.discardTitle": "Discard model mapping changes?",
    "accountPool.upstreamAccounts.modelMappings.discardDescription":
      "Your unsaved model mappings will be lost.",
    "accountPool.upstreamAccounts.modelMappings.discard": "Discard changes",
    "accountPool.upstreamAccounts.modelMappings.keepEditing": "Keep editing",
    ...
    "accountPool.tags.dialog.availableModelsMode": "Model filter mode",
    "accountPool.tags.dialog.availableModelsAllowlist": "Allowlist",
    "accountPool.tags.dialog.availableModelsDenylist": "Denylist",
    "accountPool.tags.dialog.availableModelsModeInherited": "Inherit",
    ...
    "accountPool.upstreamAccounts.modelRouting.title": "Model routing health",
    "accountPool.upstreamAccounts.modelRouting.description":
      "API key upstreams learn exact models from real traffic. Cooling models stay isolated from other candidates.",
    "accountPool.upstreamAccounts.modelRouting.empty":
      "No models have been observed in the last 7 days.",
    "accountPool.upstreamAccounts.modelRouting.state": "Route state",
    "accountPool.upstreamAccounts.modelRouting.priority": "Priority",
    "accountPool.upstreamAccounts.modelRouting.changedAt": "Changed",
    "accountPool.upstreamAccounts.modelRouting.lastSeen": "Last seen",
    "accountPool.upstreamAccounts.modelRouting.recoveryAt": "Retry after",
    "accountPool.upstreamAccounts.modelRouting.failure": "Failure",
    "accountPool.upstreamAccounts.modelRouting.model": "Model",
    ...
    "accountPool.upstreamAccounts.modelRouting.states.available": "Available",
    "accountPool.upstreamAccounts.modelRouting.states.degraded": "Degraded",
    "accountPool.upstreamAccounts.modelRouting.states.cooling_down": "Cooling down",
    "accountPool.upstreamAccounts.modelRouting.priorities.normal": "Normal",
    "accountPool.upstreamAccounts.modelRouting.priorities.demoted": "Demoted",
    "accountPool.upstreamAccounts.modelRouting.priorities.excluded": "Excluded",
    "accountPool.upstreamAccounts.modelRouting.expand": "Show model routing history",
    ...
    "accountPool.upstreamAccounts.modelRouting.history.empty":
      "No routing events in the last 48 hours.",
    "accountPool.upstreamAccounts.modelRouting.history.unavailable":
      "Account context is unavailable.",
    "accountPool.upstreamAccounts.modelRouting.history.unknown": "Unknown result",
    ...
    "accountPool.upstreamAccounts.latestAction.actions.model_route_degraded": "Model route demoted",
    "accountPool.upstreamAccounts.latestAction.actions.model_route_cooldown":
      "Model route cooling down",
    "accountPool.upstreamAccounts.latestAction.actions.model_route_recovered":
    ...
    "system.status.runtimePressure.states.unknown": "Unknown",
    "system.status.runtimePressure.details": "Runtime pressure details",
    "system.status.runtimePressure.hotTopics.title": "Dashboard hot topics",
    "system.status.runtimePressure.hotTopics.activity": "Activity",
    "system.status.runtimePressure.hotTopics.summary": "Summary",
    "system.status.runtimePressure.hotTopics.networkTimeseries": "Network timeseries",
    "system.status.runtimePressure.hotTopics.networkRecent": "Recent network",
    "system.status.runtimePressure.hotTopics.workingConversations": "Working conversations",
    "system.status.runtimePressure.hotTopics.parallelWork": "Parallel work",
    "system.status.runtimePressure.hotTopics.timeseries": "Open-window timeseries",
    "system.status.runtimePressure.rssAnon": "Anonymous RSS",
    "system.status.runtimePressure.swap": "Swap",
    "system.status.runtimePressure.managed": "Managed memory",
    "system.status.runtimePressure.unattributed": "Unattributed anonymous memory",
    ...
    "system.status.runtimePressure.rawOrphanSweep.title": "Raw orphan sweep",
    "system.status.runtimePressure.rawOrphanSweep.states.unknown": "Unknown",
    "system.status.runtimePressure.rawOrphanSweep.states.idle": "Idle",
    "system.status.runtimePressure.rawOrphanSweep.states.scanning": "Scanning",
    "system.status.runtimePressure.rawOrphanSweep.states.deferred": "Deferred",
    "system.status.runtimePressure.rawOrphanSweep.states.degraded": "Degraded",
    "system.status.runtimePressure.rawOrphanSweep.inspected": "Directory entries inspected",
    "system.status.runtimePressure.rawOrphanSweep.inspectedHint": "At most 128 entries per pass.",
    ...
    "system.status.runtimePressure.rawCapture.states.storage_suppressed": "Storage suppressed",
    "system.status.runtimePressure.rawCapture.states.unknown": "Unknown",
    "system.status.runtimePressure.rawCapture.reason": "Suppression reason",
    "system.status.runtimePressure.rawCapture.inventory": "Inventory",
    "system.status.runtimePressure.rawCapture.inventoryStates.ready": "Ready",
    "system.status.runtimePressure.rawCapture.inventoryStates.preparing": "Preparing",
    "system.status.runtimePressure.rawCapture.inventoryStates.resetting": "Resetting",
    "system.status.runtimePressure.rawCapture.inventoryStates.unknown": "Unknown",
    "system.status.runtimePressure.rawCapture.rawBytes": "Physical raw usage",
    "system.status.runtimePressure.rawCapture.availableBytes": "Filesystem available",
    "system.status.runtimePressure.rawCapture.rawWatermark": "Raw usage watermarks",
    "system.status.runtimePressure.rawCapture.filesystemWatermark": "Filesystem watermarks",
    "system.status.runtimePressure.rawCapture.watermarkClose": "Close at",
    "system.status.runtimePressure.rawCapture.watermarkResume": "Resume at",
    "system.status.runtimePressure.rawCapture.reservedBytes": "In-flight reserved",
    "system.status.runtimePressure.rawCapture.backlog": "Expired backlog trend",
    "system.status.runtimePressure.rawCapture.backlogGrowing": "Growing or unknown",
    "system.status.runtimePressure.rawCapture.backlogGrowingKnown": "Growing",
    "system.status.runtimePressure.rawCapture.backlogUnknown": "Unknown",
    "system.status.runtimePressure.rawCapture.backlogStable": "Not growing",
    "system.status.runtimePressure.rawCapture.reasons.inventory_unready": "Inventory not ready",
    "system.status.runtimePressure.rawCapture.reasons.raw_store_limit": "Raw usage limit",
    ...
    "settings.routing.models.title": "Model policy",
    "settings.routing.models.description":
      "Choose whether the selected regular and image models are allowed or denied at the root level.",
    ...
    "dashboard.activityOverview.timelineTitle": "Invocation timeline",
    "dashboard.activityOverview.timelineCalls": "{{count}} calls",
    "dashboard.activityOverview.timelineCallsAxis": "Calls",
    "dashboard.activityOverview.timelineLive": "Live",
    "dashboard.activityOverview.timelineShortenWindow": "Shorten time window",
    "dashboard.activityOverview.timelineLengthenWindow": "Lengthen time window",
    "dashboard.activityOverview.timelinePanEarlier": "Move window earlier",
    "dashboard.activityOverview.timelinePanLater": "Move window later",
    "dashboard.activityOverview.timelineTtftAxis": "TTFT",
    "dashboard.activityOverview.timelineAllDay": "All day",
    "dashboard.activityOverview.timelineStatusSuccess": "Success",
    "dashboard.activityOverview.timelineStatusRequesting": "Requesting",
    "dashboard.activityOverview.timelineStatusResponding": "Responding",
    "dashboard.activityOverview.timelineStatusQueued": "Queued",
    "dashboard.activityOverview.timelineStatusFailed": "Failed",
    "dashboard.activityOverview.timelineStatusInterrupted": "Interrupted",
    "dashboard.activityOverview.timelineStatusUnknown": "Unknown",
    "dashboard.activityOverview.timelineDurationRunning": "Running",
    "dashboard.activityOverview.timelineDurationUnknown": "Duration unknown",
    "dashboard.activityOverview.timelineOccurredAt": "Started {{time}}",
    "dashboard.activityOverview.timelineTtftValue": " · TTFT {{value}} ms",
    "dashboard.activityOverview.timelineInvocationAria":
      "{{id}} · {{occurredAt}} · {{status}} · {{duration}}{{ttft}}",
    "dashboard.activityOverview.timelineParallel": "parallel {{count}}",
    "dashboard.activityOverview.timelineRunning": "running {{count}}",
    "dashboard.activityOverview.timelineQueued": "queued {{count}}",
    "dashboard.activityOverview.timelineEmpty": "No invocations in this window.",
    "dashboard.networkRecent.title": "Recent network speed",
    "dashboard.networkRecent.subtitle": "Global upload/download over the last 5 minutes",
    ...
    "dashboard.workingConversations.earlierInvocation": "Earlier invocation",
    ...
    "dashboard.compactTiming.request": "Request time",
    "dashboard.compactTiming.ttft": "TTFT",
    "dashboard.compactTiming.response": "Response time",
    "dashboard.compactTiming.estimated": "estimated",
    ...
    "dashboard.today.responseTimeDescription":
      "TTFT and response time prefer the latest rolling 60-second samples; TTFT shows no sample when the window has none.",
    ...
    "dashboard.modelPerformance.modelSimple": "Model",
    "dashboard.modelPerformance.descriptionSimple":
      "Complete-range metrics for successful billed calls, grouped by response model.",
    ...
    "dashboard.modelPerformance.columns.firstByte": "Avg TTFT",
    ...
    "dashboard.modelBreakdown.modeLabel": "Grouping mode",
    "dashboard.modelBreakdown.simple": "Simple",
    "dashboard.modelBreakdown.detailed": "Detailed",
    "dashboard.modelBreakdown.sort.modelMenu": "Sort model rows",
    "dashboard.modelBreakdown.sort.modelAria": "Sort model rows; current {{current}}",
    "dashboard.modelBreakdown.sort.menuAria": "Sort rows",
    "dashboard.modelBreakdown.sort.name-asc": "Model name (A-Z)",
    "dashboard.modelBreakdown.sort.name-desc": "Model name (Z-A)",
    "dashboard.modelBreakdown.sort.effort-asc": "Reasoning effort (low to high)",
    "dashboard.modelBreakdown.sort.effort-desc": "Reasoning effort (high to low)",
    "dashboard.modelBreakdown.sort.metric": "Metric {{metric}}",
    "dashboard.modelBreakdown.sort.metricAria": "Sort {{metric}} {{direction}}",
    "dashboard.modelBreakdown.sort.metric-asc": "{{metric}} ascending",
    "dashboard.modelBreakdown.sort.metric-desc": "{{metric}} descending",
    ...
    "stats.successFailure.legend.firstByteAvg": "TTFT average",
    "stats.successFailure.tooltip.successRate": "Success rate",
    "stats.successFailure.tooltip.firstByteAvg": "TTFT average",
    "stats.successFailure.tooltip.firstByteP95": "TTFT P95",
    ...
    "stats.errors.countLabel": "Requests",
    "stats.errors.chartAria": "Error reasons pie chart",
    "stats.longTerm.title": "Long-term usage",
    "stats.longTerm.subtitle": "Daily usage and performance across retained history",
    "stats.longTerm.rangeLabel": "Long-term range",
    ...
    "stats.longTerm.loading": "Loading long-term statistics…",
    "stats.longTerm.preparing": "Preparing historical statistics…",
    "stats.longTerm.preparingProgress": "Processed {{processed}} of {{total}} calls",
    "stats.longTerm.error": "Long-term statistics are unavailable.",
    "stats.longTerm.empty": "No long-term usage recorded yet.",
    "stats.longTerm.emptyChart": "No data for this selection.",
    ...
    "live.tabs.label": "Live views",
    "live.tabs.conversations": "Conversations",
    "live.tabs.records": "Latest records",
    "live.tabs.routing": "Routing",
    "live.tabs.proxy": "Proxy",
    "live.routing.title": "Model routing",
    "live.routing.description":
      "API key account-model route state and real request decisions. Times are Beijing time.",
    "live.routing.refresh": "Refresh",
    "live.routing.windowLabel": "Routing window",
    "live.routing.loading": "Loading model routing…",
    "live.routing.empty": "No API key model routing state matches these filters.",
    "live.routing.accountsCount": "{{count}} accounts",
    "live.routing.modelRecordsCount": "{{count}} decisions",
    "live.routing.modelPriority.normal": "Normal candidate",
    "live.routing.modelPriority.demoted": "Demoted candidate",
    "live.routing.modelPriority.excluded": "Excluded",
    "live.routing.modelPriority.unknown": "Unknown",
    "live.routing.recordsTitle": "Latest route decisions",
    "live.routing.modelRecordsTitle": "Routing records",
    "live.routing.model.expand": "Show",
    "live.routing.model.collapse": "Hide",
    "live.routing.model.expandLabel": "Show {{model}} routing records",
    "live.routing.model.collapseLabel": "Hide {{model}} routing records",
    "live.routing.recordsEmpty": "No route attempt or state event in this window.",
    "live.routing.modelRecordsEmpty":
      "No route decision or state event for this model in this window.",
    "live.routing.states.available": "Available",
    "live.routing.states.degraded": "Degraded",
    "live.routing.states.cooling_down": "Cooling down",
    "live.routing.states.unknown": "Unknown",
    "live.routing.timeline.aria": "{{model}} routing timeline",
    "live.routing.timeline.empty": "No route state or request attempt in this window.",
    ...
    "live.routing.record.attempt": "Route attempt",
    "live.routing.record.retry": "Retry {{index}}",
    "live.routing.record.event": "State event",
    "live.routing.record.reason": "Reason",
    "live.routing.record.result": "Result",
    "live.routing.record.comparison": "Candidate comparison",
    "live.routing.record.eligible": "{{count}} eligible",
    "live.routing.record.compared": "Compared with {{account}}",
    "live.routing.record.transition": "State transition",
    "live.routing.record.priorityTransition": "Priority transition",
    "live.routing.record.source": "Routing source",
    "live.routing.record.failureCount": "Failure count",
    "live.routing.record.cooldownUntil": "Cooldown until",
    "live.routing.record.comparedId": "Compared with API Key #{{accountId}}",
    "live.routing.record.comparedName": "Compared with {{account}}",
    ...
    "live.routing.record.handoffDecisions.bypassedDisabled": "Bypassed: disabled",
    "live.routing.record.handoffPhases.verifying": "Verifying",
    "live.routing.record.handoffPhases.open": "Open",
    "live.routing.record.handoffPhases.coolingDown": "Cooling down",
    ...
    "live.conversations.drawer.tabs.routing": "Routing",
    "live.conversations.drawer.tabs.settings": "Settings",
    "live.conversations.drawer.tabs.operations": "Events",
    ...
    "live.conversations.drawer.routing.currentTitle": "Current routing",
    "live.conversations.drawer.routing.currentDescription":
      "Manual constraints, encrypted owner, fallback, and model-specific Sticky targets.",
    "live.conversations.drawer.routing.reset": "Clear binding and reselect",
    "live.conversations.drawer.routing.model": "Model scope",
    "live.conversations.drawer.routing.account": "Upstream account",
    "live.conversations.drawer.routing.openAccount": "View details for {{account}}",
    "live.conversations.drawer.routing.created": "Created",
    "live.conversations.drawer.routing.updated": "Updated",
    "live.conversations.drawer.routing.lastUsed": "Last used",
    "live.conversations.drawer.routing.allModels": "All models",
    "live.conversations.drawer.routing.empty": "No current Sticky routes.",
    "live.conversations.drawer.routing.resetConfirm.title": "Clear binding and reselect?",
    "live.conversations.drawer.routing.resetConfirm.description":
      "This removes the manual binding, encrypted-session owner lock, and every Sticky route for this conversation.",
    "live.conversations.drawer.routing.resetConfirm.cancel": "Cancel",
    "live.conversations.drawer.routing.resetConfirm.confirm": "Clear and reselect",
    "live.conversations.drawer.operations.title": "Event records",
    "live.conversations.drawer.operations.description":
      "Review routing, forward-proxy, and request-rewrite events for this conversation.",
    "live.conversations.drawer.operations.loading": "Loading event records",
    "live.conversations.drawer.operations.empty": "No event records yet.",
    "live.conversations.drawer.operations.loadMore": "Load more",
    "live.conversations.drawer.operations.loadingMore": "Loading more…",
    "live.conversations.drawer.operations.changedFields": "Changed: {{fields}}",
    ...
    "live.conversations.drawer.operations.filters.requestRewrite": "Request rewrite",
    "live.conversations.drawer.operations.modelFilter.label": "Routing model",
    "live.conversations.drawer.operations.modelFilter.any": "Any model scope",
    "live.conversations.drawer.operations.modelFilter.allModels": "All-model scope",
    "live.conversations.drawer.operations.modelScope.all": "All models",
    "live.conversations.drawer.operations.modelScope.model": "Model: {{model}}",
    "live.conversations.drawer.operations.requestModel": "Request model: {{model}}",
    "live.conversations.drawer.operations.modelTransition": "{{model}}: {{from}} -> {{to}}",
    "live.conversations.drawer.operations.origins.detailDrawer": "Detail drawer",
    "live.conversations.drawer.operations.origins.dashboardBulk": "Dashboard bulk",
    "live.conversations.drawer.operations.origins.systemAuto": "System auto",
    "live.conversations.drawer.operations.actions.manualBindingUpdated": "Manual binding updated",
    "live.conversations.drawer.operations.actions.bindingCleared": "Manual binding cleared",
    ...
    "live.conversations.drawer.operations.binding.group": "Group {{group}}",
    "live.conversations.drawer.operations.binding.account": "Account {{account}}",
    "live.conversations.drawer.operations.sticky.none": "No sticky target",
    "live.conversations.drawer.operations.fields.bindingKind": "Binding target",
    "live.conversations.drawer.operations.fields.stickyTarget": "Sticky target",
    "live.conversations.drawer.operations.fields.allowSwitchUpstream": "Switch out",
    "live.conversations.drawer.operations.fields.fastModeRewriteMode": "FAST mode",
    "live.conversations.drawer.operations.fields.imageToolRewriteMode": "Image tool",
    "live.conversations.drawer.operations.fields.availableModels": "Available models",
    "live.conversations.drawer.operations.fields.forwardProxyKey": "Forward proxy",
    "live.conversations.drawer.operations.fields.forwardProxyKeys": "Forward proxy",
    "live.conversations.drawer.operations.fields.responsesFirstByteTimeoutSecs":
      "Responses first-byte timeout",
    "live.conversations.drawer.operations.fields.compactFirstByteTimeoutSecs":
      "Compact first-byte timeout",
    "live.conversations.drawer.operations.fields.imageFirstByteTimeoutSecs":
      "Image first-byte timeout",
    "live.conversations.drawer.operations.fields.responsesStreamTimeoutSecs":
      "Responses stream timeout",
    "live.conversations.drawer.operations.fields.compactStreamTimeoutSecs":
      "Compact stream timeout",
    ...
    "records.filters.rangeMinPlaceholder": "Min",
    "records.filters.rangeMaxPlaceholder": "Max",
    "records.filters.status": "Status",
    "records.filters.status.all": "All statuses",
    "records.filters.status.success": "Success",
    "records.filters.status.warningSuccess": "Warning success",
    ...
    "records.filters.modelHint":
      "Use a tag selector to choose multiple models, optionally narrow by reasoning effort, and choose whether to match request-side or response-side models.",
    "records.filters.modelTarget": "Match side",
    "records.filters.modelTarget.request": "Request",
    "records.filters.modelTarget.response": "Response",
    "records.filters.modelRerouted": "Reroute",
    "records.filters.modelRerouted.all": "All",
    "records.filters.modelRerouted.rerouted": "Rerouted",
    "records.filters.modelRerouted.notRerouted": "Not rerouted",
    "records.filters.modelPlaceholder": "Select models",
    "records.filters.endpoint": "Endpoint",
    "records.filters.invokeId": "Invocation ID",
    "records.filters.attemptId": "Attempt ID",
    ...
    "records.filters.upstreamScope": "Route scope",
    "records.filters.upstreamScope.all": "All routes",
    "records.filters.upstreamScope.external": "External",
    "records.filters.upstreamScope.internal": "Internal",
    "records.filters.upstreamAccount": "Upstream account",
    "records.filters.proxyDisplayName": "Proxy node",
    "records.filters.transport": "Transport",
    "records.filters.transport.all": "All transports",
    "records.filters.transport.http": "HTTP",
    "records.filters.transport.websocket": "WebSocket",
    "records.filters.serviceTier": "Service tier",
    "records.filters.reasoningEffort": "Reasoning effort",
    "records.filters.reasoningEffortPlaceholder": "Select reasoning effort",
    "records.filters.failureKind": "Failure kind",
    "records.filters.promptCacheKey": "Prompt Cache Key",
    "records.filters.stickyKey": "Sticky Key",
    "records.filters.requesterIp": "Requester IP",
    "records.filters.keyword": "Keyword",
    "records.filters.totalTokensRange": "Total tokens",
    "records.filters.totalTokensRange.min": "Minimum total tokens",
    "records.filters.totalTokensRange.max": "Maximum total tokens",
    "records.filters.totalMsRange": "Total duration",
    "records.filters.totalMsRange.min": "Minimum total duration",
    "records.filters.totalMsRange.max": "Maximum total duration",
    ...
    "records.filters.groups.range": "Range",
    "records.filters.groups.requestContext": "Request context",
    "records.filters.groups.routing": "Routing & upstream",
    "records.filters.groups.result": "Result",
    "records.filters.validation.timeRange.invalid": "Enter a valid time range.",
    "records.filters.validation.timeRange.order": "End time must be after start time.",
    "records.filters.validation.totalTokens.invalid": "Total tokens range must use numbers.",
    "records.filters.validation.totalTokens.integer": "Total tokens range must use whole numbers.",
    "records.filters.validation.totalTokens.order":
      "Total tokens range must be in ascending order.",
    "records.filters.validation.totalMs.invalid": "Total duration range must use numbers.",
    "records.filters.validation.totalMs.order": "Total duration range must be in ascending order.",
    "records.filters.validation.modelFilters.missingModel":
      "Choose at least one model before applying a reasoning-effort filter.",
    ...
    "records.filters.multiValue.add": "Add",
    ...
    "records.summary.token.cacheWrite": "Uncached input tokens",
    ...
    "records.summary.token.output": "Output tokens",
    "records.summary.token.totalCost": "Total cost",
    "records.summary.token.amount": "Amount",
    "records.summary.network.avgTtfb": "Avg TTFB",
    "records.summary.network.p95Ttfb": "P95 TTFB",
    "records.summary.network.avgFirstToken": "Avg TTFT",
    "records.summary.network.p95FirstToken": "P95 TTFT",
    "records.summary.network.avgResponseDuration": "Avg response time",
    "records.summary.network.p95ResponseDuration": "P95 response time",
    ...
    "records.table.focusTitle": "Token and cost",
    ...
    "records.costAudit.localShort": "Local",
    "records.costAudit.notComparable": "Local recompute unavailable",
    "records.costAudit.warningAria": "Cost mismatch warning",
    "records.costAudit.tooltip.title": "Cost mismatch",
    "records.costAudit.tooltip.recorded": "Recorded",
    "records.costAudit.tooltip.local": "Local",
    "records.costAudit.tooltip.diff": "Diff",
    "records.costAudit.tooltip.recordedVersion": "Recorded price version",
    "records.costAudit.tooltip.localVersion": "Local price version",
    "records.costAudit.reason.totalMismatch":
      "Recorded cost differs from the current local recomputation.",
    "records.costAudit.reason.priceVersionChanged":
      "Recorded cost was persisted under a different price version than the current local catalog.",
    "records.costAudit.reason.recordedCostMissing":
      "The record does not include a persisted total cost, so only the local recomputation is available.",
    "records.costAudit.reason.recordedPriceVersionMissing":
      "The record does not include a persisted price version, so the local comparison mode cannot be reconstructed safely.",
    "records.costAudit.reason.pricingModeUnknown":
      "The persisted price version uses an unknown pricing mode suffix, so the local comparison was skipped.",
    "records.costAudit.reason.usageMissing":
      "The response does not carry enough usage evidence to recompute local cost.",
    "records.costAudit.reason.modelMissing":
      "The record does not include a billable response model, so local cost could not be recomputed.",
    "records.costAudit.reason.modelPricingMissing":
      "The current pricing catalog does not include this response model, so local cost could not be recomputed.",
    "records.table.network.endpoint": "Endpoint",
    "records.table.network.requesterIp": "Requester IP",
    "records.table.network.ttfb": "TTFB",
    "records.table.network.firstToken": "TTFT",
    "records.table.network.responseDuration": "Response time",
    ...
    "table.column.firstToken": "TTFT",
    "table.column.firstByteCompression": "First byte / HTTP compression",
    "table.column.firstTokenCompression": "TTFT / HTTP compression",
    "table.column.responseDurationCompression": "Response time / HTTP request compression",
    "table.column.totalLatencyShort": "Elapsed",
    "table.column.firstByteLatencyShort": "TTFB",
    "table.column.firstTokenShort": "TTFT",
    ...
    "table.status.warningSuccess": "Warning success",
    ...
    "table.endpoint.responsesBadge": "Normal",
    "table.endpoint.chatBadge": "Chat",
    "table.endpoint.compactBadge": "Compact",
    "table.endpoint.imageGenBadge": "image/gen",
    "table.endpoint.imageEditBadge": "image/edit",
    "table.endpoint.imageBadge": "image",
    ...
    "table.details.firstByteLatency": "TTFB / upstream first byte",
    "table.details.firstToken": "TTFT",
    "table.details.httpCompression": "HTTP compression",
    "table.details.requestHttpCompression": "HTTP request compression",
    "table.details.responseHttpCompression": "HTTP response compression",
    ...
    "table.details.stage.upstreamFirstByte": "TTFB / upstream first byte",
    ...
    "table.poolAttempts.firstByteLatency": "TTFB / upstream first byte",
    ...
    "chart.firstToken": "TTFT",
    "chart.tokenBreakdown.cacheRead": "Cached input",
    "chart.tokenBreakdown.cacheWrite": "Cache write",
    "chart.tokenBreakdown.output": "Output",
    "chart.tokenBreakdown.reasoning": "Reasoning",
    "chart.tokenBreakdown.total": "Total",
    "chart.tokenBreakdown.cacheHitRate": "10 min cache hit",
    "chart.tokenBreakdown.hourlyCacheHitRate": "1 hour cache hit",
    "unit.calls": "calls",
  ...
  zh: {
    ...
    "accountPool.upstreamAccounts.healthDetails": "展开诊断详情",
    ...
    "accountPool.upstreamAccounts.records.title": "尝试请求",
    "accountPool.upstreamAccounts.records.activityOverviewTitle": "账号活动总览",
    "accountPool.upstreamAccounts.records.description":
      "查看这个上游账号最近 7 天的每一次尝试请求、重试和结果。",
    "accountPool.upstreamAccounts.records.limitLabel": "记录数量",
    "accountPool.upstreamAccounts.records.limitOption": "{{count}} 条尝试请求",
    "accountPool.upstreamAccounts.records.empty": "这个上游账号最近 7 天暂时还没有尝试请求。",
    "accountPool.upstreamAccounts.records.loadingMore": "正在加载更多尝试请求...",
    "accountPool.upstreamAccounts.records.loaded": "已加载 {{loaded}} / {{total}} 条尝试请求",
    "accountPool.upstreamAccounts.records.allLoaded": "已加载全部 {{count}} 条尝试请求",
    "accountPool.upstreamAccounts.records.locating": "正在定位所选请求...",
    "accountPool.upstreamAccounts.records.locateUnavailable":
      "定位请求未完成；实时更新仍保持暂停。",
    "accountPool.upstreamAccounts.records.located":
      "正在查看请求 {{invokeId}} 所在的冻结历史窗口。",
    "accountPool.upstreamAccounts.records.returnLatest": "返回最新请求",
    "accountPool.upstreamAccounts.records.locateNotFound":
      "未找到请求 {{invokeId}}，该记录可能已被清理。",
    "accountPool.upstreamAccounts.records.locateFailed": "无法定位请求 {{invokeId}}。",
    "accountPool.upstreamAccounts.records.retryLocate": "重试",
    "accountPool.upstreamAccounts.records.anchoredLoaded":
      "已加载目标请求附近 {{loaded}} / {{total}} 条尝试请求",
    ...
    "accountPool.upstreamAccounts.effectiveRule.availableModelsAllowed": "允许模型",
    ...
    "accountPool.upstreamAccounts.detailTabs.records": "请求",
    "accountPool.upstreamAttempts.locateUnavailable":
      "该历史事件没有可定位的上游尝试，或尝试已超出 7 天保留范围。",
    "accountPool.upstreamAttempts.empty": "最近 7 天没有该账号的尝试请求。",
    "accountPool.upstreamAttempts.description":
      "最近 7 天主库中的尝试请求。每行对应一次真实上游尝试请求。",
    ...
    "accountPool.upstreamAttempts.filters.type": "类型",
    "accountPool.upstreamAttempts.filters.typeAll": "全部类型",
    "accountPool.upstreamAttempts.filters.model": "模型",
    "accountPool.upstreamAttempts.filters.modelAll": "全部模型",
    "accountPool.upstreamAttempts.filters.conversation": "对话",
    "accountPool.upstreamAttempts.filters.conversationAll": "全部对话",
    "accountPool.upstreamAttempts.filters.conversationUnbound": "未绑定对话",
    ...
    "accountPool.upstreamAttempts.compressionRatio": "压缩比",
    "accountPool.upstreamAttempts.approxUpload": "近似上传",
    "accountPool.upstreamAttempts.approxDownload": "近似下载",
    ...
    "accountPool.upstreamAttempts.columns.call": "请求 ID",
    "accountPool.upstreamAttempts.callShortId": "调用短 ID",
    ...
    "accountPool.upstreamAttempts.total": "{{count}} 条尝试请求",
    ...
    "accountPool.upstreamAccounts.modelMappings.title": "模型映射",
    "accountPool.upstreamAccounts.modelMappings.description":
      "将请求模型映射为实际发送给此上游账号的目标模型名。",
    "accountPool.upstreamAccounts.modelMappings.add": "新增映射",
    "accountPool.upstreamAccounts.modelMappings.sourceModel": "原模型",
    "accountPool.upstreamAccounts.modelMappings.targetModel": "目标模型",
    "accountPool.upstreamAccounts.modelMappings.enabled": "启用",
    "accountPool.upstreamAccounts.modelMappings.sourcePlaceholder": "请求模型或 * 匹配规则",
    "accountPool.upstreamAccounts.modelMappings.targetPlaceholder": "实际发送给上游的模型名",
    "accountPool.upstreamAccounts.modelMappings.noSuggestions": "没有建议模型",
    "accountPool.upstreamAccounts.modelMappings.reorder": "调整映射顺序",
    "accountPool.upstreamAccounts.modelMappings.remove": "删除映射",
    "accountPool.upstreamAccounts.modelMappings.empty": "此账号尚未配置模型映射。",
    "accountPool.upstreamAccounts.modelMappings.validation.empty":
      "每条映射都需要填写原模型和目标模型。",
    "accountPool.upstreamAccounts.modelMappings.validation.duplicate":
    ...
    "accountPool.upstreamAccounts.modelMappings.discardTitle": "放弃模型映射修改？",
    "accountPool.upstreamAccounts.modelMappings.discardDescription": "未保存的模型映射将会丢失。",
    "accountPool.upstreamAccounts.modelMappings.discard": "放弃修改",
    "accountPool.upstreamAccounts.modelMappings.keepEditing": "继续编辑",
    ...
    "accountPool.tags.dialog.availableModelsMode": "模型过滤模式",
    "accountPool.tags.dialog.availableModelsAllowlist": "白名单",
    "accountPool.tags.dialog.availableModelsDenylist": "黑名单",
    "accountPool.tags.dialog.availableModelsModeInherited": "继承",
    ...
    "accountPool.upstreamAccounts.modelRouting.title": "模型路由健康",
    "accountPool.upstreamAccounts.modelRouting.description":
      "API Key 上游仅根据真实流量记忆精确模型；冷却中的模型不会拖累其它模型候选。",
    "accountPool.upstreamAccounts.modelRouting.empty": "近 7 天还没有真实调用发现的模型。",
    "accountPool.upstreamAccounts.modelRouting.state": "路由状态",
    "accountPool.upstreamAccounts.modelRouting.priority": "优先级",
    "accountPool.upstreamAccounts.modelRouting.changedAt": "变更时间",
    "accountPool.upstreamAccounts.modelRouting.lastSeen": "最近调用",
    "accountPool.upstreamAccounts.modelRouting.recoveryAt": "预计恢复",
    "accountPool.upstreamAccounts.modelRouting.failure": "失败摘要",
    "accountPool.upstreamAccounts.modelRouting.model": "模型",
    ...
    "accountPool.upstreamAccounts.modelRouting.states.available": "可用",
    "accountPool.upstreamAccounts.modelRouting.states.degraded": "降权",
    "accountPool.upstreamAccounts.modelRouting.states.cooling_down": "冷却中",
    "accountPool.upstreamAccounts.modelRouting.priorities.normal": "正常",
    "accountPool.upstreamAccounts.modelRouting.priorities.demoted": "降权",
    "accountPool.upstreamAccounts.modelRouting.priorities.excluded": "排除",
    "accountPool.upstreamAccounts.modelRouting.expand": "展开模型路由历史",
    ...
    "accountPool.upstreamAccounts.modelRouting.history.empty": "最近 48 小时没有路由事件。",
    "accountPool.upstreamAccounts.modelRouting.history.unavailable": "账号上下文不可用。",
    "accountPool.upstreamAccounts.modelRouting.history.unknown": "未知结果",
    ...
    "accountPool.upstreamAccounts.latestAction.actions.model_route_degraded": "模型路由降权",
    "accountPool.upstreamAccounts.latestAction.actions.model_route_cooldown": "模型路由冷却中",
    ...
    "system.status.runtimePressure.states.unknown": "未知",
    "system.status.runtimePressure.details": "运行压力详情",
    "system.status.runtimePressure.hotTopics.title": "Dashboard 高频主题",
    "system.status.runtimePressure.hotTopics.activity": "活动概览",
    "system.status.runtimePressure.hotTopics.summary": "汇总",
    "system.status.runtimePressure.hotTopics.networkTimeseries": "网络时间序列",
    "system.status.runtimePressure.hotTopics.networkRecent": "近期网络",
    "system.status.runtimePressure.hotTopics.workingConversations": "工作中会话",
    "system.status.runtimePressure.hotTopics.parallelWork": "并行工作",
    "system.status.runtimePressure.hotTopics.timeseries": "开放窗口时间序列",
    "system.status.runtimePressure.rssAnon": "匿名 RSS",
    "system.status.runtimePressure.swap": "Swap",
    "system.status.runtimePressure.managed": "已归因内存",
    "system.status.runtimePressure.unattributed": "未归因匿名内存",
    ...
    "system.status.runtimePressure.rawOrphanSweep.title": "raw 孤儿清扫",
    "system.status.runtimePressure.rawOrphanSweep.states.unknown": "未知",
    "system.status.runtimePressure.rawOrphanSweep.states.idle": "空闲",
    "system.status.runtimePressure.rawOrphanSweep.states.scanning": "扫描中",
    "system.status.runtimePressure.rawOrphanSweep.states.deferred": "已延后",
    "system.status.runtimePressure.rawOrphanSweep.states.degraded": "异常",
    "system.status.runtimePressure.rawOrphanSweep.inspected": "已检查目录项",
    "system.status.runtimePressure.rawOrphanSweep.inspectedHint": "每轮最多检查 128 项。",
    ...
    "system.status.runtimePressure.rawCapture.states.storage_suppressed": "已抑制落盘",
    "system.status.runtimePressure.rawCapture.states.unknown": "未知",
    "system.status.runtimePressure.rawCapture.reason": "抑制原因",
    "system.status.runtimePressure.rawCapture.inventory": "库存状态",
    "system.status.runtimePressure.rawCapture.inventoryStates.ready": "已就绪",
    "system.status.runtimePressure.rawCapture.inventoryStates.preparing": "准备中",
    "system.status.runtimePressure.rawCapture.inventoryStates.resetting": "重置中",
    "system.status.runtimePressure.rawCapture.inventoryStates.unknown": "未知",
    "system.status.runtimePressure.rawCapture.rawBytes": "原始文件物理占用",
    "system.status.runtimePressure.rawCapture.availableBytes": "文件系统可用空间",
    "system.status.runtimePressure.rawCapture.rawWatermark": "原始占用水位",
    "system.status.runtimePressure.rawCapture.filesystemWatermark": "文件系统水位",
    "system.status.runtimePressure.rawCapture.watermarkClose": "关闭阈值",
    "system.status.runtimePressure.rawCapture.watermarkResume": "恢复阈值",
    "system.status.runtimePressure.rawCapture.reservedBytes": "进行中预留",
    "system.status.runtimePressure.rawCapture.backlog": "过期积压趋势",
    "system.status.runtimePressure.rawCapture.backlogGrowing": "增长中或未知",
    "system.status.runtimePressure.rawCapture.backlogGrowingKnown": "增长中",
    "system.status.runtimePressure.rawCapture.backlogUnknown": "未知",
    "system.status.runtimePressure.rawCapture.backlogStable": "未增长",
    "system.status.runtimePressure.rawCapture.reasons.inventory_unready": "库存尚未就绪",
    "system.status.runtimePressure.rawCapture.reasons.raw_store_limit": "原始占用达到上限",
    ...
    "settings.routing.models.title": "模型过滤策略",
    "settings.routing.models.description": "在根级选择允许或拒绝的普通模型与生图模型。",
    ...
    "dashboard.activityOverview.timelineTitle": "对外调用时间线",
    "dashboard.activityOverview.timelineCalls": "{{count}} 次调用",
    "dashboard.activityOverview.timelineCallsAxis": "调用",
    "dashboard.activityOverview.timelineLive": "实时更新",
    "dashboard.activityOverview.timelineShortenWindow": "缩短时间窗口",
    "dashboard.activityOverview.timelineLengthenWindow": "拉长时间窗口",
    "dashboard.activityOverview.timelinePanEarlier": "向前移动时间窗口",
    "dashboard.activityOverview.timelinePanLater": "向后移动时间窗口",
    "dashboard.activityOverview.timelineTtftAxis": "TTFT",
    "dashboard.activityOverview.timelineAllDay": "全天",
    "dashboard.activityOverview.timelineStatusSuccess": "成功",
    "dashboard.activityOverview.timelineStatusRequesting": "请求中",
    "dashboard.activityOverview.timelineStatusResponding": "响应中",
    "dashboard.activityOverview.timelineStatusQueued": "排队中",
    "dashboard.activityOverview.timelineStatusFailed": "失败",
    "dashboard.activityOverview.timelineStatusInterrupted": "已中断",
    "dashboard.activityOverview.timelineStatusUnknown": "未知",
    "dashboard.activityOverview.timelineDurationRunning": "运行中",
    "dashboard.activityOverview.timelineDurationUnknown": "时长未知",
    "dashboard.activityOverview.timelineOccurredAt": "开始时间 {{time}}",
    "dashboard.activityOverview.timelineTtftValue": " · TTFT {{value}} 毫秒",
    "dashboard.activityOverview.timelineInvocationAria":
      "{{id}} · {{occurredAt}} · {{status}} · {{duration}}{{ttft}}",
    "dashboard.activityOverview.timelineParallel": "并行 {{count}}",
    "dashboard.activityOverview.timelineRunning": "运行 {{count}}",
    "dashboard.activityOverview.timelineQueued": "排队 {{count}}",
    "dashboard.activityOverview.timelineEmpty": "当前时间窗口没有对外调用。",
    ...
    "dashboard.workingConversations.earlierInvocation": "更早调用",
    ...
    "dashboard.today.firstResponseTime": "TTFT",
    "dashboard.compactTiming.request": "请求用时",
    "dashboard.compactTiming.ttft": "TTFT",
    "dashboard.compactTiming.response": "响应耗时",
    "dashboard.compactTiming.estimated": "暂估",
    ...
    "dashboard.today.responseTimeDescription":
      "TTFT 与响应时间优先显示最近 60 秒滚动样本；窗口无新 TTFT 样本时显示暂无样本。",
    ...
    "dashboard.modelPerformance.modelSimple": "模型",
    "dashboard.modelPerformance.descriptionSimple":
      "仅统计成功且已计费调用，按响应模型汇总当前范围完整周期的指标。",
    ...
    "dashboard.modelPerformance.columns.firstByte": "平均 TTFT",
    ...
    "dashboard.modelBreakdown.modeLabel": "分组模式",
    "dashboard.modelBreakdown.simple": "简单",
    "dashboard.modelBreakdown.detailed": "详细",
    "dashboard.modelBreakdown.sort.modelMenu": "模型行排序",
    "dashboard.modelBreakdown.sort.modelAria": "模型行排序；当前{{current}}",
    "dashboard.modelBreakdown.sort.menuAria": "排序行",
    "dashboard.modelBreakdown.sort.name-asc": "模型名称正序",
    "dashboard.modelBreakdown.sort.name-desc": "模型名称倒序",
    "dashboard.modelBreakdown.sort.effort-asc": "思考程度正序",
    "dashboard.modelBreakdown.sort.effort-desc": "思考程度倒序",
    "dashboard.modelBreakdown.sort.metric": "指标{{metric}}",
    "dashboard.modelBreakdown.sort.metricAria": "按{{metric}}{{direction}}排序",
    "dashboard.modelBreakdown.sort.metric-asc": "{{metric}}升序",
    "dashboard.modelBreakdown.sort.metric-desc": "{{metric}}降序",
    "dashboard.today.inProgressConversationsDescription":
    ...
    "stats.successFailure.legend.firstByteAvg": "TTFT 均值",
    "stats.successFailure.tooltip.successRate": "成功率",
    "stats.successFailure.tooltip.firstByteAvg": "TTFT 均值",
    "stats.successFailure.tooltip.firstByteP95": "TTFT P95",
    ...
    "stats.errors.countLabel": "次数",
    "stats.errors.chartAria": "错误原因饼图",
    "stats.longTerm.title": "长期用量统计",
    "stats.longTerm.subtitle": "按上海自然日查看长期用量与性能",
    "stats.longTerm.rangeLabel": "长期统计范围",
    "stats.longTerm.range.7d": "最近 7 天",
    "stats.longTerm.range.30d": "最近 30 天",
    "stats.longTerm.range.180d": "最近半年",
    "stats.longTerm.range.365d": "最近一年",
    "stats.longTerm.loading": "正在加载长期统计…",
    "stats.longTerm.preparing": "正在准备历史统计…",
    "stats.longTerm.preparingProgress": "已处理 {{processed}} / {{total}} 次调用",
    "stats.longTerm.error": "长期统计暂不可用。",
    "stats.longTerm.empty": "暂未记录长期用量。",
    "stats.longTerm.emptyChart": "当前选择暂无数据。",
    "stats.longTerm.search": "搜索名称",
    "stats.longTerm.select": "选择",
    "stats.longTerm.name": "名称",
    "stats.longTerm.modelAndReasoning": "模型 / 思考程度",
    "stats.longTerm.total": "总计",
    "stats.longTerm.unspecified": "未指定",
    "stats.longTerm.global": "全部调用",
    "stats.longTerm.global.tokens": "总 Token",
    "stats.longTerm.global.cost": "总成本",
    "stats.longTerm.global.calls": "总调用次数",
    "stats.longTerm.tokens": "Token",
    "stats.longTerm.cost": "成本",
    "stats.longTerm.calls": "调用次数",
    "stats.longTerm.metric.tokens": "Token",
    "stats.longTerm.metric.cost": "成本",
    "stats.longTerm.metric.calls": "调用次数",
    "stats.longTerm.metric.usageTime": "使用时间",
    "stats.longTerm.metric.wallTime": "墙上时间",
    "stats.longTerm.metric.outputSpeed": "输出速度",
    "stats.longTerm.metric.firstByte": "首字用时",
    "stats.longTerm.metric.response": "响应时间",
    "stats.longTerm.globalTrend": "全局趋势",
    "stats.longTerm.modelTime": "模型时间",
    "stats.longTerm.modelPerformance": "模型性能",
    "stats.longTerm.modelUsage": "模型用量",
    "stats.longTerm.models": "模型",
    "stats.longTerm.upstreamUsage": "上游账号",
    "stats.longTerm.upstreams": "账号",
    "quota.title": "配额概览",
    ...
    "live.tabs.label": "实况视图",
    "live.tabs.conversations": "对话",
    "live.tabs.records": "最新记录",
    "live.tabs.routing": "路由",
    "live.tabs.proxy": "代理",
    "live.routing.title": "模型路由",
    "live.routing.description": "API Key 账号-模型路由状态与真实请求决策，时间为北京时间。",
    "live.routing.refresh": "刷新",
    "live.routing.windowLabel": "路由时间窗",
    "live.routing.loading": "正在加载模型路由…",
    "live.routing.empty": "没有符合筛选条件的 API Key 模型路由状态。",
    "live.routing.accountsCount": "{{count}} 个账号",
    "live.routing.modelRecordsCount": "{{count}} 条决策",
    "live.routing.modelPriority.normal": "正常候选",
    "live.routing.modelPriority.demoted": "降权候选",
    "live.routing.modelPriority.excluded": "已排除",
    "live.routing.modelPriority.unknown": "未知",
    "live.routing.recordsTitle": "最新路由决策",
    "live.routing.modelRecordsTitle": "路由记录",
    "live.routing.model.expand": "展开",
    "live.routing.model.collapse": "收起",
    "live.routing.model.expandLabel": "展开 {{model}} 路由记录",
    "live.routing.model.collapseLabel": "收起 {{model}} 路由记录",
    "live.routing.recordsEmpty": "当前时间窗内没有路由尝试或状态事件。",
    "live.routing.modelRecordsEmpty": "当前时间窗内没有该模型的路由决策或状态事件。",
    "live.routing.states.available": "可用",
    "live.routing.states.degraded": "降权",
    "live.routing.states.cooling_down": "冷却中",
    "live.routing.states.unknown": "未知",
    "live.routing.timeline.aria": "{{model}} 路由时间线",
    "live.routing.timeline.empty": "当前时间窗内没有可观察的路由状态或请求尝试。",
    ...
    "live.routing.record.attempt": "路由尝试",
    "live.routing.record.retry": "重试 {{index}}",
    "live.routing.record.event": "状态事件",
    "live.routing.record.reason": "原因",
    "live.routing.record.result": "结果",
    "live.routing.record.comparison": "候选比较",
    "live.routing.record.eligible": "{{count}} 个可用候选",
    "live.routing.record.compared": "与 {{account}} 比较",
    "live.routing.record.transition": "状态迁移",
    "live.routing.record.priorityTransition": "优先级迁移",
    "live.routing.record.source": "路由来源",
    "live.routing.record.failureCount": "失败次数",
    "live.routing.record.cooldownUntil": "冷却结束",
    "live.routing.record.comparedId": "与 API Key #{{accountId}} 比较",
    "live.routing.record.comparedName": "与 {{account}} 比较",
    ...
    "live.routing.record.handoffDecisions.bypassedDisabled": "跳过：开关关闭",
    "live.routing.record.handoffPhases.verifying": "验证中",
    "live.routing.record.handoffPhases.open": "已开放",
    "live.routing.record.handoffPhases.coolingDown": "冷却中",
    ...
    "live.conversations.drawer.tabs.routing": "路由",
    "live.conversations.drawer.tabs.settings": "设置",
    "live.conversations.drawer.tabs.operations": "事件记录",
    ...
    "live.conversations.drawer.routing.currentTitle": "当前路由",
    "live.conversations.drawer.routing.currentDescription":
      "展示手工约束、加密 owner、全部模型兜底和各模型 Sticky 目标。",
    "live.conversations.drawer.routing.reset": "清空绑定并重选",
    "live.conversations.drawer.routing.model": "模型范围",
    "live.conversations.drawer.routing.account": "上游账号",
    "live.conversations.drawer.routing.openAccount": "查看 {{account}} 的账号详情",
    "live.conversations.drawer.routing.created": "创建时间",
    "live.conversations.drawer.routing.updated": "更新时间",
    "live.conversations.drawer.routing.lastUsed": "最近使用",
    "live.conversations.drawer.routing.allModels": "全部模型",
    "live.conversations.drawer.routing.empty": "当前没有 Sticky 路由。",
    "live.conversations.drawer.routing.resetConfirm.title": "清空绑定并重选？",
    "live.conversations.drawer.routing.resetConfirm.description":
      "这会清除当前对话的手工绑定、加密会话 owner 锁及所有 Sticky 路由。",
    "live.conversations.drawer.routing.resetConfirm.cancel": "取消",
    "live.conversations.drawer.routing.resetConfirm.confirm": "清空并重选",
    "live.conversations.drawer.operations.title": "事件记录",
    "live.conversations.drawer.operations.description":
      "查看当前对话的路由、正向代理与请求改写事件。",
    "live.conversations.drawer.operations.loading": "加载事件记录中",
    "live.conversations.drawer.operations.empty": "当前还没有事件记录。",
    "live.conversations.drawer.operations.loadMore": "加载更多",
    "live.conversations.drawer.operations.loadingMore": "加载更多中…",
    "live.conversations.drawer.operations.changedFields": "变更字段：{{fields}}",
    ...
    "live.conversations.drawer.operations.filters.requestRewrite": "请求改写相关",
    "live.conversations.drawer.operations.modelFilter.label": "路由模型",
    "live.conversations.drawer.operations.modelFilter.any": "不限模型范围",
    "live.conversations.drawer.operations.modelFilter.allModels": "全部模型范围",
    "live.conversations.drawer.operations.modelScope.all": "全部模型",
    "live.conversations.drawer.operations.modelScope.model": "模型：{{model}}",
    "live.conversations.drawer.operations.requestModel": "原始请求模型：{{model}}",
    "live.conversations.drawer.operations.modelTransition": "{{model}}：{{from}} -> {{to}}",
    "live.conversations.drawer.operations.origins.detailDrawer": "详情抽屉",
    "live.conversations.drawer.operations.origins.dashboardBulk": "Dashboard 批量",
    "live.conversations.drawer.operations.origins.systemAuto": "系统自动",
    "live.conversations.drawer.operations.actions.manualBindingUpdated": "手工绑定已更新",
    "live.conversations.drawer.operations.actions.bindingCleared": "手工绑定已清空",
    ...
    "live.conversations.drawer.operations.binding.group": "分组 {{group}}",
    "live.conversations.drawer.operations.binding.account": "账号 {{account}}",
    "live.conversations.drawer.operations.sticky.none": "无 Sticky 目标",
    "live.conversations.drawer.operations.fields.bindingKind": "绑定目标",
    "live.conversations.drawer.operations.fields.stickyTarget": "Sticky 目标",
    "live.conversations.drawer.operations.fields.allowSwitchUpstream": "切出",
    "live.conversations.drawer.operations.fields.fastModeRewriteMode": "FAST 模式",
    "live.conversations.drawer.operations.fields.imageToolRewriteMode": "图片工具",
    "live.conversations.drawer.operations.fields.availableModels": "可用模型",
    "live.conversations.drawer.operations.fields.forwardProxyKey": "正向代理",
    "live.conversations.drawer.operations.fields.forwardProxyKeys": "正向代理",
    "live.conversations.drawer.operations.fields.responsesFirstByteTimeoutSecs":
      "一般请求响应体首字超时",
    "live.conversations.drawer.operations.fields.compactFirstByteTimeoutSecs":
      "压缩请求响应体首字超时",
    "live.conversations.drawer.operations.fields.imageFirstByteTimeoutSecs":
      "图片请求响应体首字超时",
    "live.conversations.drawer.operations.fields.responsesStreamTimeoutSecs": "一般请求流结束超时",
    "live.conversations.drawer.operations.fields.compactStreamTimeoutSecs": "压缩请求流结束超时",
    ...
    "records.filters.rangeMinPlaceholder": "最小值",
    "records.filters.rangeMaxPlaceholder": "最大值",
    "records.filters.status": "状态",
    "records.filters.status.all": "全部状态",
    "records.filters.status.success": "成功",
    "records.filters.status.warningSuccess": "警告成功",
    ...
    "records.filters.modelHint":
      "使用标签选择器多选模型，并可选追加推理强度；还可以切换按请求侧或响应侧模型筛选。",
    "records.filters.modelTarget": "匹配侧",
    "records.filters.modelTarget.request": "请求",
    "records.filters.modelTarget.response": "响应",
    "records.filters.modelRerouted": "重路由",
    "records.filters.modelRerouted.all": "全部",
    "records.filters.modelRerouted.rerouted": "已重路由",
    "records.filters.modelRerouted.notRerouted": "未重路由",
    "records.filters.modelPlaceholder": "选择模型",
    "records.filters.endpoint": "端点",
    "records.filters.invokeId": "调用 ID",
    "records.filters.attemptId": "尝试 ID",
    ...
    "records.filters.upstreamScope": "路由范围",
    "records.filters.upstreamScope.all": "全部范围",
    "records.filters.upstreamScope.external": "外部",
    "records.filters.upstreamScope.internal": "内部",
    "records.filters.upstreamAccount": "上游账号",
    "records.filters.proxyDisplayName": "代理节点",
    "records.filters.transport": "传输方式",
    "records.filters.transport.all": "全部方式",
    "records.filters.transport.http": "HTTP",
    "records.filters.transport.websocket": "WebSocket",
    "records.filters.serviceTier": "服务层级",
    "records.filters.reasoningEffort": "推理强度",
    "records.filters.reasoningEffortPlaceholder": "选择推理强度",
    "records.filters.failureKind": "失败分类",
    "records.filters.promptCacheKey": "Prompt Cache Key",
    "records.filters.stickyKey": "Sticky Key",
    "records.filters.requesterIp": "请求方 IP",
    "records.filters.keyword": "关键词",
    "records.filters.totalTokensRange": "总 Tokens",
    "records.filters.totalTokensRange.min": "最小总 Tokens",
    "records.filters.totalTokensRange.max": "最大总 Tokens",
    "records.filters.totalMsRange": "总耗时",
    "records.filters.totalMsRange.min": "最小总耗时",
    "records.filters.totalMsRange.max": "最大总耗时",
    ...
    "records.filters.groups.range": "范围",
    "records.filters.groups.requestContext": "请求上下文",
    "records.filters.groups.routing": "路由与上游",
    "records.filters.groups.result": "结果",
    "records.filters.validation.timeRange.invalid": "请输入有效的时间范围。",
    "records.filters.validation.timeRange.order": "结束时间必须晚于开始时间。",
    "records.filters.validation.totalTokens.invalid": "总 Tokens 范围必须填写数字。",
    "records.filters.validation.totalTokens.integer": "总 Tokens 范围必须填写整数。",
    "records.filters.validation.totalTokens.order": "总 Tokens 范围必须从小到大。",
    "records.filters.validation.totalMs.invalid": "总耗时范围必须填写数字。",
    "records.filters.validation.totalMs.order": "总耗时范围必须从小到大。",
    "records.filters.validation.modelFilters.missingModel":
      "先选择至少一个模型，再使用推理强度筛选。",
    ...
    "records.filters.multiValue.add": "添加",
    ...
    "records.summary.token.cacheWrite": "未命中缓存输入 Tokens",
    ...
    "records.summary.token.output": "输出 Tokens",
    "records.summary.token.totalCost": "总成本",
    "records.summary.token.amount": "金额",
    "records.summary.network.avgTtfb": "平均 TTFB",
    "records.summary.network.p95Ttfb": "P95 TTFB",
    "records.summary.network.avgFirstToken": "平均 TTFT",
    "records.summary.network.p95FirstToken": "P95 TTFT",
    "records.summary.network.avgResponseDuration": "平均响应耗时",
    "records.summary.network.p95ResponseDuration": "P95 响应耗时",
    ...
    "records.table.focusTitle": "Token 与成本",
    ...
    "records.costAudit.localShort": "本地",
    "records.costAudit.notComparable": "当前无法做本地重算对账",
    "records.costAudit.warningAria": "成本不一致警告",
    "records.costAudit.tooltip.title": "成本不一致",
    "records.costAudit.tooltip.recorded": "记录值",
    "records.costAudit.tooltip.local": "本地重算",
    "records.costAudit.tooltip.diff": "差值",
    "records.costAudit.tooltip.recordedVersion": "记录价表版本",
    "records.costAudit.tooltip.localVersion": "本地价表版本",
    "records.costAudit.reason.totalMismatch": "已持久化的成本与当前本地重算结果不一致。",
    "records.costAudit.reason.priceVersionChanged":
      "该记录使用的持久化价表版本与当前本地价表版本不同。",
    "records.costAudit.reason.recordedCostMissing":
      "该记录没有持久化总成本，只能展示本地重算结果。",
    "records.costAudit.reason.recordedPriceVersionMissing":
      "该记录缺少持久化价表版本，无法安全恢复本地对账模式。",
    "records.costAudit.reason.pricingModeUnknown":
      "该记录的持久化价表后缀无法识别，本地对账已跳过。",
    "records.costAudit.reason.usageMissing": "当前响应缺少足够的 usage 证据，无法重算本地成本。",
    "records.costAudit.reason.modelMissing": "该记录缺少可计费的响应模型，无法重算本地成本。",
    "records.costAudit.reason.modelPricingMissing":
      "当前价表里没有这个响应模型的定价，无法重算本地成本。",
    "records.table.network.endpoint": "端点",
    "records.table.network.requesterIp": "请求方 IP",
    "records.table.network.ttfb": "TTFB",
    "records.table.network.firstToken": "TTFT",
    "records.table.network.responseDuration": "响应耗时",
    ...
    "table.column.firstToken": "TTFT",
    "table.column.firstByteCompression": "TTFB / HTTP 压缩",
    "table.column.firstTokenCompression": "TTFT / HTTP 压缩",
    "table.column.responseDurationCompression": "响应耗时 / HTTP 请求压缩",
    ...
    "table.status.warningSuccess": "警告成功",
    ...
    "table.endpoint.responsesBadge": "一般",
    "table.endpoint.chatBadge": "Chat",
    "table.endpoint.compactBadge": "Compact",
    "table.endpoint.imageGenBadge": "image/gen",
    "table.endpoint.imageEditBadge": "image/edit",
    ...
    "table.details.firstByteLatency": "TTFB / 上游首字节",
    "table.details.firstToken": "TTFT",
    "table.details.httpCompression": "HTTP 压缩算法",
    "table.details.requestHttpCompression": "HTTP 请求压缩",
    "table.details.responseHttpCompression": "HTTP 响应压缩",
    "table.details.requestedServiceTier": "Requested service tier",
    "table.details.serviceTier": "Service tier",
    "table.details.billingServiceTier": "Billing service tier",
    ...
    "table.details.stage.upstreamFirstByte": "TTFB / 上游首字节",
    ...
    "table.poolAttempts.originalModel": "原模型",
    "table.poolAttempts.upstreamRequestModel": "上游模型",
    "table.poolAttempts.modelMappingPattern": "命中映射",
    "table.poolAttempts.modelNotSent": "未发送",
    "table.poolAttempts.connectLatency": "连接耗时",
    "table.poolAttempts.firstByteLatency": "TTFB / 上游首字节",
    ...
    "chart.firstToken": "TTFT",
    "chart.tokenBreakdown.cacheRead": "缓存输入",
    "chart.tokenBreakdown.cacheWrite": "缓存写入",
    "chart.tokenBreakdown.output": "输出",
    "chart.tokenBreakdown.reasoning": "思考",
    "chart.tokenBreakdown.total": "总计",
    "chart.tokenBreakdown.cacheHitRate": "10 分钟缓存命中率",
    "chart.tokenBreakdown.hourlyCacheHitRate": "1 小时缓存命中率",
    "unit.calls": "次",
