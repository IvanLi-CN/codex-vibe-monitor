...
const baseTranslations = {
  en: {
    ...
    'settings.forwardProxy.modal.step1Hint': 'Paste node lines and run validation.',
    'settings.forwardProxy.modal.step2Hint': 'Review deduped results and add available nodes.',
  ...
  zh: {
    ...
    'settings.forwardProxy.modal.step1Hint': '粘贴节点并执行可用性验证。',
    'settings.forwardProxy.modal.step2Hint': '查看去重结果并添加可用节点。',
