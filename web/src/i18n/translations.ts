...
const baseTranslations = {
  en: {
    ...
    'accountPool.upstreamAccounts.actions.manualCopyMailbox': 'Auto copy failed. Please copy the mailbox below manually.',
    ...
    'accountPool.upstreamAccounts.import.createTitle': 'Import Codex OAuth JSON',
    ...
    'accountPool.upstreamAccounts.import.selectedFilesEmpty': 'No JSON file selected yet.',
    'accountPool.upstreamAccounts.import.filesSelected': '{{count}} files selected',
    'accountPool.upstreamAccounts.import.clearSelection': 'Clear selection',
    'accountPool.upstreamAccounts.import.defaultGroupPlaceholder': 'Apply a default group to newly created imports',
    ...
    'accountPool.upstreamAccounts.import.validation.checking': 'Validating selected credential files…',
    ...
    'accountPool.upstreamAccounts.import.validation.resultsCount': 'Showing {{shown}} of {{total}} rows.',
    ...
    'accountPool.upstreamAccounts.batchOauth.validation.mailboxFormat': 'Enter a valid email address before attaching it.',
    ...
    'accountPool.upstreamAccounts.batchOauth.tooltip.editMailboxBody': 'Edit this row mailbox inside the popover, then submit the address to attach mailbox enhancements without leaving the table.',
    ...
    'accountPool.upstreamAccounts.batchOauth.tooltip.invitedBody': 'This mailbox already received a workspace invite email.',
    'accountPool.upstreamAccounts.batchOauth.tooltip.notInvitedTitle': 'No invite yet',
    'accountPool.upstreamAccounts.batchOauth.tooltip.notInvitedBody': 'This mailbox has not received a workspace invite email yet.',
    ...
    'accountPool.upstreamAccounts.groupNotes.tooltip.body': 'Edit the shared note for this group. Existing groups save immediately; brand-new groups stay local until an account actually lands in the group.',
    'accountPool.upstreamAccounts.groupNotes.dialogTitle': 'Group note',
    'accountPool.upstreamAccounts.groupNotes.existingDescription': 'This group already exists. Saving here updates the shared note for every account in the group immediately.',
    'accountPool.upstreamAccounts.groupNotes.draftDescription': 'This group does not exist yet. Saving here stores a local draft and the note will be persisted when the first account is actually created in this group.',
    ...
    'accountPool.upstreamAccounts.batchOauth.tooltip.motherBody': 'Mark this row as the mother account for its group. Other drafts in the same group will immediately give up the crown.',
    ...
    'accountPool.upstreamAccounts.editDescription': 'Update display metadata, the per-account upstream base URL, local placeholder limits, or rotate the API key without deleting the account.',
    ...
    'accountPool.upstreamAccounts.effectiveRule.description': 'This is the merged policy currently applied to the account after all selected tags are combined.',
    'accountPool.upstreamAccounts.effectiveRule.noTags': 'No tag is attached, so the account keeps the default pool routing behavior.',
    'accountPool.upstreamAccounts.effectiveRule.guardEnabled': 'Conversation guard on',
    'accountPool.upstreamAccounts.effectiveRule.guardDisabled': 'Conversation guard off',
    ...
    'accountPool.upstreamAccounts.effectiveRule.guardRule': 'Max {{count}} conversations within {{hours}} hour(s)',
    'accountPool.upstreamAccounts.effectiveRule.allGuardsApply': 'All active guards must pass',
    ...
    'accountPool.upstreamAccounts.hints.dataPlaneUnavailableTitle': 'The OAuth data plane is unavailable',
    'accountPool.upstreamAccounts.hints.dataPlaneUnavailableBody': 'The main service could not reach the in-process OAuth Codex upstream. Check outbound connectivity to chatgpt.com and make sure this deployment is not still running the removed bridge-only build.',
    'accountPool.upstreamAccounts.hints.bridgeExchangeTitle': 'This OAuth account still shows a legacy bridge error',
    'accountPool.upstreamAccounts.hints.bridgeExchangeBody': 'The stored last_error came from the removed OAuth bridge path. A fresh sync or successful route should overwrite it; if the same text reappears, this deployment is still running an old build.',
    'accountPool.upstreamAccounts.hints.dataPlaneRejectedTitle': 'The OAuth data plane rejected this request',
    'accountPool.upstreamAccounts.hints.dataPlaneRejectedBody': 'The in-process OAuth Codex adapter reached the upstream data plane, but the request was rejected. Check the upstream message for missing scopes, permissions, or other account-specific failures before re-authorizing.',
    'accountPool.upstreamAccounts.hints.reauthTitle': 'This OAuth account needs a fresh sign-in',
    'accountPool.upstreamAccounts.hints.reauthBody': 'The upstream token or refresh grant is no longer valid. Re-authorize this account to issue a new token set.',
    ...
    'accountPool.tags.description': 'Create reusable tags for upstream accounts and manage routing rules, account coverage, and group coverage in one place.',
    'accountPool.tags.actions.create': 'Create tag',
    'accountPool.tags.listTitle': 'Tag list',
    'accountPool.tags.listDescription': 'Review every tag, its routing rule summary, and how many accounts or groups are affected.',
    ...
    'accountPool.tags.dialog.description': 'Adjust the tag name and the routing rules that accounts under this tag must follow.',
    'accountPool.tags.dialog.name': 'Tag name',
    'accountPool.tags.dialog.namePlaceholder': 'For example: vip, night-shift, warm-standby',
    'accountPool.tags.dialog.guardEnabled': 'Limit conversations within a rolling time window',
    'accountPool.tags.dialog.lookbackHours': 'Lookback hours',
    'accountPool.tags.dialog.maxConversations': 'Max conversations',
    'accountPool.tags.dialog.allowCutOut': 'Allow moving conversations out of this account',
    'accountPool.tags.dialog.allowCutIn': 'Allow moving conversations into this account',
    ...
    'accountPool.tags.dialog.validation': 'When the guard is enabled, both lookback hours and max conversations must be positive integers.',
    ...
    'accountPool.upstreamAccounts.oauth.regenerateRequired': 'Group note changed. Generate a fresh OAuth URL before completing login.',
    ...
    'accountPool.upstreamAccounts.oauth.mailboxHint': 'Generate a temp mailbox or enter a MoeMail address here. Supported addresses keep code parsing and invite detection enabled.',
    'accountPool.upstreamAccounts.oauth.mailboxEmpty': 'No mailbox yet',
    'accountPool.upstreamAccounts.oauth.mailboxInputPlaceholder': 'Enter a supported mailbox address or generate a new one',
    ...
    'accountPool.upstreamAccounts.oauth.mailboxExpired': 'This temp mailbox has expired. Generate a fresh mailbox before waiting for new mail.',
    'accountPool.upstreamAccounts.oauth.mailboxStatusUnavailable': 'Mailbox status is unavailable right now. Generate a fresh mailbox if this keeps happening.',
    'accountPool.upstreamAccounts.oauth.mailboxStatusRefreshFailed': 'Mailbox refresh failed. We could not confirm the latest code or invite state.',
    ...
    'accountPool.upstreamAccounts.oauth.refreshScheduledUnknown': 'Waiting for the next refresh window',
    'accountPool.upstreamAccounts.oauth.receivedAt': 'Received at {{timestamp}}',
    'accountPool.upstreamAccounts.oauth.mailboxUnsupportedInvalidFormat': 'This does not look like a valid email address, so mailbox enhancements stay disabled.',
    'accountPool.upstreamAccounts.oauth.mailboxUnsupportedDomain': 'This mailbox domain is not supported by the current MoeMail integration, so mailbox enhancements stay disabled.',
    'accountPool.upstreamAccounts.oauth.mailboxUnsupportedNotReadable': 'This mailbox is not readable through the current MoeMail integration, so mailbox enhancements stay disabled.',
    ...
    'accountPool.upstreamAccounts.fields.generatedMailboxPlaceholder': 'Generate a temp mailbox for this OAuth flow',
    ...
    'accountPool.upstreamAccounts.fields.upstreamBaseUrlPlaceholder': 'Leave blank to use OPENAI_UPSTREAM_BASE_URL',
    'accountPool.upstreamAccounts.validation.upstreamBaseUrlInvalid': 'Use an absolute http(s) URL, for example https://proxy.example.com/gateway',
    'accountPool.upstreamAccounts.validation.upstreamBaseUrlNoQueryOrFragment': 'Upstream base URL cannot include a query string or fragment.',
    ...
    'accountPool.upstreamAccounts.duplicate.compactBody': 'Matched: {{reasons}}. Related account ids: {{peers}}.',
    ...
    'accountPool.upstreamAccounts.mother.toggleDescription': 'Each group can keep only one mother account. Turning this on automatically moves the crown away from the previous owner.',
    ...
    'accountPool.upstreamAccounts.mother.notifications.replaced': '{{next}} is now the mother account for {{group}}. The crown moved from {{previous}}.',
    'accountPool.upstreamAccounts.mother.notifications.created': '{{next}} is now the mother account for {{group}}.',
    'accountPool.upstreamAccounts.mother.notifications.cleared': '{{previous}} is no longer the mother account for {{group}}.',
    ...
    'table.accountDrawer.emptyBody': 'This account may have been removed, or the current request no longer links to an available account.',
    'table.accountDrawer.openAccountPool': 'Open in account pool',
    'table.accountDrawer.healthTitle': 'Health',
    'table.accountDrawer.healthDescription': 'Recent sync, token, and error status for this upstream account.',
  ...
  zh: {
    ...
    'accountPool.upstreamAccounts.actions.manualCopyMailbox': '自动复制失败，请手动复制下面的邮箱地址。',
    ...
    'accountPool.upstreamAccounts.import.createDescription': '选择一个或多个导出的 Codex OAuth 凭据 JSON 文件，先批量验活，再导入可用账号。',
    'accountPool.upstreamAccounts.import.fileInputLabel': '凭据 JSON 文件',
    'accountPool.upstreamAccounts.import.selectedFilesTitle': '已选文件',
    'accountPool.upstreamAccounts.import.selectedFilesEmpty': '还没有选择 JSON 文件。',
    'accountPool.upstreamAccounts.import.filesSelected': '已选择 {{count}} 个文件',
    ...
    'accountPool.upstreamAccounts.import.defaultMetadataHint': '默认分组备注和标签只会应用到新建账号，命中已有账号时不会覆盖现有元数据。',
    'accountPool.upstreamAccounts.import.validateAction': '验证并预览',
    'accountPool.upstreamAccounts.import.validation.title': '导入验证',
    'accountPool.upstreamAccounts.import.validation.description': '已检查 {{files}} 个文件中的 {{checked}} / {{total}} 个唯一凭据。',
    'accountPool.upstreamAccounts.import.validation.checking': '正在验证所选凭据文件…',
    ...
    'accountPool.upstreamAccounts.import.validation.resultsCount': '当前显示 {{shown}} / {{total}} 行。',
    ...
    'accountPool.upstreamAccounts.import.validation.footerHint': '当前有 {{valid}} 个文件可导入，输入内重复 {{duplicates}} 个。',
    ...
    'accountPool.upstreamAccounts.batchOauth.validation.mailboxFormat': '请先填写格式正确的邮箱地址，再执行附着。',
    ...
    'accountPool.upstreamAccounts.batchOauth.tooltip.editMailboxBody': '在悬浮气泡里直接编辑这行邮箱地址，提交后即可附着邮箱增强能力，不用离开表格。',
    ...
    'accountPool.upstreamAccounts.batchOauth.tooltip.invitedBody': '这个邮箱已经收到工作区邀请邮件。',
    'accountPool.upstreamAccounts.batchOauth.tooltip.notInvitedTitle': '暂未受邀',
    'accountPool.upstreamAccounts.batchOauth.tooltip.notInvitedBody': '这个邮箱暂时还没有收到工作区邀请邮件。',
    ...
    'accountPool.upstreamAccounts.groupNotes.tooltip.body': '编辑这个分组的共享备注。已有分组会立即保存；全新分组会先保存在当前页面，等真正有账号落进该分组时再持久化。',
    'accountPool.upstreamAccounts.groupNotes.dialogTitle': '分组备注',
    'accountPool.upstreamAccounts.groupNotes.existingDescription': '这个分组已经存在，保存后会立即更新该分组下所有账号共用的备注。',
    'accountPool.upstreamAccounts.groupNotes.draftDescription': '这个分组还没有实际账号，当前保存只会写入本页草稿；等首个账号真正创建到该分组时才会持久化。',
    ...
    'accountPool.upstreamAccounts.batchOauth.tooltip.motherBody': '把这一行设为所在分组的母号；同组其他草稿行会立刻让出皇冠标记。',
    ...
    'accountPool.upstreamAccounts.editDescription': '更新显示名称、备注、账号级上游地址、本地限额，或者轮换 API Key，不必删除后重建。',
    ...
    'accountPool.upstreamAccounts.effectiveRule.description': '这里展示的是当前账号在所有已关联 tag 合并后，真正参与路由判定的规则。',
    'accountPool.upstreamAccounts.effectiveRule.noTags': '当前没有关联 tag，所以这个账号仍使用号池默认路由行为。',
    'accountPool.upstreamAccounts.effectiveRule.guardEnabled': '会话上限已开启',
    'accountPool.upstreamAccounts.effectiveRule.guardDisabled': '会话上限未开启',
    ...
    'accountPool.upstreamAccounts.effectiveRule.guardRule': '{{hours}} 小时内最多 {{count}} 个对话',
    'accountPool.upstreamAccounts.effectiveRule.allGuardsApply': '所有已开启的上限规则都会同时生效',
    ...
    'accountPool.upstreamAccounts.hints.dataPlaneUnavailableBody': '主服务暂时连不到内联 OAuth Codex 上游。先检查到 chatgpt.com 的出网连通性，并确认当前部署不是还停留在旧 bridge 版本。',
    'accountPool.upstreamAccounts.hints.bridgeExchangeTitle': '这个 OAuth 账号仍在展示历史 bridge 错误',
    'accountPool.upstreamAccounts.hints.bridgeExchangeBody': '当前展示的 last_error 来自已经移除的 OAuth bridge 链路。只要再完成一次成功同步或路由，它通常就会被覆盖；如果同样的文案再次出现，说明部署还在跑旧版本。',
    'accountPool.upstreamAccounts.hints.dataPlaneRejectedTitle': 'OAuth 数据面拒绝了这次请求',
    'accountPool.upstreamAccounts.hints.dataPlaneRejectedBody': '内联 OAuth Codex adapter 已经连到数据面上游，但请求被拒绝了。先检查上游返回里的 scopes、权限或账号能力，再决定是否需要重新授权。',
    'accountPool.upstreamAccounts.hints.reauthTitle': '这个 OAuth 账号需要重新登录',
    'accountPool.upstreamAccounts.hints.reauthBody': '上游 token 或 refresh grant 已经失效。请重新授权这个账号，生成一套新的凭据。',
    ...
    'accountPool.tags.description': '集中管理上游账号标签、路由规则摘要，以及它们覆盖的账号和账号分组范围。',
    ...
    'accountPool.tags.dialog.validation': '开启会话上限后，“回看小时数”和“最大对话数”都必须是正整数。',
    ...
    'accountPool.upstreamAccounts.oauth.regenerateRequired': '分组备注已变更，请先重新生成 OAuth 地址再完成登录。',
    ...
    'accountPool.upstreamAccounts.oauth.callbackUrlPlaceholder': 'http://localhost:43210/oauth/callback?code=...&state=...',
    'accountPool.upstreamAccounts.oauth.mailboxHint': '这里既可以生成临时邮箱，也可以手动填写已接入的 MoeMail 邮箱；只有受支持地址才会继续启用验证码解析和邀请识别。',
    'accountPool.upstreamAccounts.oauth.mailboxEmpty': '还没有生成邮箱',
    'accountPool.upstreamAccounts.oauth.mailboxInputPlaceholder': '填写已支持的邮箱地址，或者直接生成一个新邮箱',
    'accountPool.upstreamAccounts.oauth.mailboxGenerated': '已生成邮箱',
    'accountPool.upstreamAccounts.oauth.mailboxAttached': '已附着邮箱',
    'accountPool.upstreamAccounts.oauth.mailboxExpired': '这个临时邮箱已经过期了。请重新生成一个新邮箱再等新邮件。',
    'accountPool.upstreamAccounts.oauth.mailboxStatusUnavailable': '暂时拿不到这个邮箱的状态。如果持续这样，建议重新生成一个新邮箱。',
    'accountPool.upstreamAccounts.oauth.mailboxStatusRefreshFailed': '邮箱状态刷新失败，暂时无法确认最新验证码或邀请状态。',
    ...
    'accountPool.upstreamAccounts.oauth.mailboxUnsupportedInvalidFormat': '这个邮箱地址格式不正确，所以邮箱增强能力暂时不会启用。',
    'accountPool.upstreamAccounts.oauth.mailboxUnsupportedDomain': '这个邮箱域名不在当前 MoeMail 集成支持范围内，所以邮箱增强能力暂时不会启用。',
    'accountPool.upstreamAccounts.oauth.mailboxUnsupportedNotReadable': '当前 MoeMail 集成暂时读不到这个邮箱，所以邮箱增强能力暂时不会启用。',
    ...
    'accountPool.upstreamAccounts.fields.generatedMailboxPlaceholder': '为这次 OAuth 流程生成一个临时邮箱',
    ...
    'accountPool.upstreamAccounts.fields.upstreamBaseUrlPlaceholder': '留空则使用全局 OPENAI_UPSTREAM_BASE_URL',
    'accountPool.upstreamAccounts.validation.upstreamBaseUrlInvalid': '请填写 http(s) 的绝对 URL，例如 https://proxy.example.com/gateway',
    'accountPool.upstreamAccounts.validation.upstreamBaseUrlNoQueryOrFragment': '上游地址不能包含查询串或片段。',
    ...
    'accountPool.upstreamAccounts.duplicate.compactBody': '命中：{{reasons}}。关联账号 ID：{{peers}}。',
    ...
    'accountPool.upstreamAccounts.mother.toggleDescription': '每个分组只能保留一个母号。开启后会自动把同组旧母号的皇冠切走。',
    ...
    'accountPool.upstreamAccounts.mother.notifications.replaced': '{{group}} 的母号已切换为 {{next}}，原母号 {{previous}} 已自动退位。',
    'accountPool.upstreamAccounts.mother.notifications.created': '{{next}} 已成为 {{group}} 的母号。',
    'accountPool.upstreamAccounts.mother.notifications.cleared': '{{previous}} 已不再是 {{group}} 的母号。',
    'settings.title': '设置',
