...
const baseTranslations = {
  en: {
    ...
    'accountPool.upstreamAccounts.deleteConfirmTitle': 'Delete this upstream account?',
    'accountPool.upstreamAccounts.deleteConfirmBody': 'Remove {{name}} from the pool now. This deletes the local account record and does not keep a recovery copy.',
  ...
  zh: {
    ...
    'accountPool.upstreamAccounts.deleteConfirmTitle': '删除这个上游账号？',
    'accountPool.upstreamAccounts.deleteConfirmBody': '现在就把 {{name}} 从号池移除。该操作会删除本地账号记录，不会保留恢复副本。',
    'accountPool.upstreamAccounts.kind.oauth': 'OAuth',
    'accountPool.upstreamAccounts.kind.apiKey': 'API Key',
