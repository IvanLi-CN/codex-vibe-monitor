...
const baseTranslations = {
  en: {
    ...
    'accountPool.upstreamAccounts.oauth.createDescription': 'Open the official login page in a one-time popup, then bind the callback result back to this service.',
    ...
    'accountPool.upstreamAccounts.createPage.description': 'Open one dedicated screen to create OAuth or API key accounts without squeezing the roster view.',
  ...
  zh: {
    ...
    'accountPool.upstreamAccounts.oauth.createDescription': '通过一次性登录弹窗打开官方授权页，再把回调结果绑定回当前服务。',
