...
const baseTranslations = {
  en: {
    ...
    'settings.forwardProxy.addProxy': 'Add proxy node',
  ...
  zh: {
    ...
    'settings.forwardProxy.addProxy': '添加代理节点',
    ...
    'settings.forwardProxy.modal.proxyTitle': '添加代理节点',
    'settings.forwardProxy.modal.subscriptionTitle': '添加订阅链接',
    'settings.forwardProxy.modal.proxyInputLabel': '代理 URL',
