...
const baseTranslations = {
  en: {
    ...
    'accountPool.upstreamAccounts.oauth.mailboxHint': 'Generate a temp mailbox here. Click the address to copy it.',
  ...
  zh: {
    ...
    'accountPool.upstreamAccounts.oauth.callbackUrlPlaceholder': 'http://localhost:43210/oauth/callback?code=...&state=...',
    'accountPool.upstreamAccounts.oauth.mailboxHint': '在这里生成临时邮箱，点击邮箱地址即可复制。',
