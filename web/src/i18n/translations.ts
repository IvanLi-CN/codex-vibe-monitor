...
const baseTranslations = {
  en: {
    ...
    "stats.liveRequestStreaming.coverage": "Coverage {{rate}} · {{count}} / {{total}}",
    ...
    "stats.liveRequestStreaming.insufficient": "Insufficient samples: {{count}} / {{minimum}}",
    "stats.liveRequestStreaming.metricCoverage": "Minimum metric samples: {{count}} / {{minimum}}",
    "stats.liveRequestStreaming.noEffectiveTreatment":
      "No actual live-first samples. {{count}} treatment request(s) fell back to buffered, so benefits are unavailable.",
    "stats.liveRequestStreaming.treatmentFallbackNotice":
      "{{count}} treatment request(s) fell back to buffered and are excluded from live-first benefits.",
    ...
    "stats.liveRequestStreaming.fallbackReasons": "Fallback reasons",
    ...
    "stats.liveRequestStreaming.routeRawRatio": "Raw buffered ratio (P50 / P90 / P99)",
    "stats.liveRequestStreaming.routeLogicalRatio": "Logical buffered ratio (P50 / P90 / P99)",
    ...
    "stats.liveRequestStreaming.evaluationWindow": "Window {{start}} – {{end}}",
    "stats.liveRequestStreaming.evaluationStatus.keep": "Recommend keep",
    "stats.liveRequestStreaming.evaluationStatus.remove": "Recommend remove",
    "stats.liveRequestStreaming.evaluationStatus.insufficient": "Insufficient data",
    "stats.liveRequestStreaming.evaluationStatus.review": "Review required",
    ...
    "stats.liveRequestStreaming.evaluationResponse": "response",
    "stats.liveRequestStreaming.evaluationToken": "token",
    "stats.liveRequestStreaming.evaluationOverlap": "overlap",
    "stats.liveRequestStreaming.evaluationFirstAttempt": "first-attempt",
    "stats.liveRequestStreaming.evaluationFallbackRisk": "fallback",
    "stats.liveRequestStreaming.evaluationCapture": "capture",
    "stats.liveRequestStreaming.evaluationDelivery": "delivery",
  ...
  zh: {
    ...
    "stats.liveRequestStreaming.title": "请求体实时转发",
    "stats.liveRequestStreaming.subtitle": "对比缓冲对照组与实际实时首发流量；实验回退单独展示",
    "stats.liveRequestStreaming.coverage": "覆盖率 {{rate}} · {{count}} / {{total}}",
    "stats.liveRequestStreaming.control": "缓冲对照组",
    "stats.liveRequestStreaming.treatment": "实际实时首发实验组",
    "stats.liveRequestStreaming.treatmentFallback": "实验组回退：缓冲转发",
    "stats.liveRequestStreaming.insufficient": "样本不足：{{count}} / {{minimum}}",
    "stats.liveRequestStreaming.metricCoverage": "最低指标样本：{{count}} / {{minimum}}",
    "stats.liveRequestStreaming.noEffectiveTreatment":
      "尚无实际实时首发样本。{{count}} 个实验组请求已回退为缓冲转发，收益不可比较。",
    "stats.liveRequestStreaming.treatmentFallbackNotice":
      "{{count}} 个实验组请求已回退为缓冲转发，不计入实时首发收益。",
    "stats.liveRequestStreaming.firstResponse": "P50 首响应",
    "stats.liveRequestStreaming.firstToken": "P50 首 token",
    "stats.liveRequestStreaming.overlap": "P50 上传重叠",
    "stats.liveRequestStreaming.retryRisk": "回退 / 重试",
    "stats.liveRequestStreaming.fallbackReasons": "回退原因",
    "stats.liveRequestStreaming.responseBenefit": "首响应收益",
    "stats.liveRequestStreaming.tokenBenefit": "首 token 收益",
    "stats.liveRequestStreaming.overlapBenefit": "重叠收益",
    "stats.liveRequestStreaming.routeFinalization": "路由最终化",
    "stats.liveRequestStreaming.routeRawBytes": "路由确定原始字节（P50 / P90 / P99）",
    "stats.liveRequestStreaming.routeLogicalBytes": "路由确定逻辑字节（P50 / P90 / P99）",
    "stats.liveRequestStreaming.routeRawRatio": "原始缓冲比例（P50 / P90 / P99）",
    "stats.liveRequestStreaming.routeLogicalRatio": "逻辑缓冲比例（P50 / P90 / P99）",
    "stats.liveRequestStreaming.routeFinalizationMs": "P50 路由确定耗时",
    "stats.liveRequestStreaming.routeEofBuffered": "EOF 后最终化",
    "stats.liveRequestStreaming.routeConservativeBuffered": "保守缓冲率",
    "stats.liveRequestStreaming.routeOutcomes": "路由结果",
    "stats.liveRequestStreaming.routeCacheHit": "路由缓存命中",
    "stats.liveRequestStreaming.routeColdLoad": "路由冷加载",
    "stats.liveRequestStreaming.evaluationTitle": "固定 7 天窗口结论",
    "stats.liveRequestStreaming.evaluationWindow": "窗口 {{start}} – {{end}}",
    "stats.liveRequestStreaming.evaluationStatus.keep": "建议保留",
    "stats.liveRequestStreaming.evaluationStatus.remove": "建议移除",
    "stats.liveRequestStreaming.evaluationStatus.insufficient": "样本不足",
    "stats.liveRequestStreaming.evaluationStatus.review": "需要人工审查",
    "stats.liveRequestStreaming.evaluationAssignments": "实验组分配",
    "stats.liveRequestStreaming.evaluationActualRate": "实际实时首发",
    "stats.liveRequestStreaming.evaluationFallbacks": "缓冲回退",
    "stats.liveRequestStreaming.evaluationReasonCodes": "判定 reason code",
    "stats.liveRequestStreaming.evaluationEvidence": "证据",
    "stats.liveRequestStreaming.evaluationMetric": "P50 收益区间",
    "stats.liveRequestStreaming.evaluationRisk": "风险增幅上界",
    "stats.liveRequestStreaming.evaluationResponse": "首响应",
    "stats.liveRequestStreaming.evaluationToken": "首 token",
    "stats.liveRequestStreaming.evaluationOverlap": "重叠",
    "stats.liveRequestStreaming.evaluationFirstAttempt": "首尝试",
    "stats.liveRequestStreaming.evaluationFallbackRisk": "回退",
    "stats.liveRequestStreaming.evaluationCapture": "捕获",
    "stats.liveRequestStreaming.evaluationDelivery": "投递",
