...
const baseTranslations = {
  en: {
    ...
    'records.summary.notice.tooltip': 'The current list uses the snapshot from your most recent search. Paging, sorting, and focus changes stay on that snapshot. Click Search to align with the latest data.',
    'records.summary.notice.helpAria': 'Explain new records notice',
  ...
  zh: {
    ...
    'records.summary.notice.tooltip': '当前列表基于最近一次搜索快照。分页、排序和聚焦切换都不会自动并入这些新数据；点击搜索即可对齐最新数据。',
    'records.summary.notice.helpAria': '查看新数据提示说明',
