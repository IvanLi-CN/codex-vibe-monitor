...
const baseTranslations = {
  en: {
    ...
    'live.proxy.description': 'Per-node windows and last 24h success/failure trend.',
    'live.proxy.table.proxy': 'Proxy',
    'live.proxy.table.trend24h': '24h success/failure',
    'live.proxy.table.successShort': 'S {{count}}',
    'live.proxy.table.failureShort': 'F {{count}}',
  ...
  zh: {
    ...
    'live.proxy.description': '按节点展示多窗口统计与最近 24 小时成功/失败趋势。',
    'live.proxy.table.proxy': '代理',
    'live.proxy.table.trend24h': '24 小时成败',
    'live.proxy.table.successShort': '成 {{count}}',
    'live.proxy.table.failureShort': '败 {{count}}',
