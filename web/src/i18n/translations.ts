...
const baseTranslations = {
  en: {
    ...
    'accountPool.upstreamAccounts.oauth.copyFailed': 'Copy failed. Copy the OAuth URL manually from the text area.',
    ...
    'accountPool.upstreamAccounts.oauth.authUrlLabel': 'OAuth URL',
    'accountPool.upstreamAccounts.oauth.authUrlDescription': 'Copy this URL to the target browser. Do not open it directly in this page.',
    'accountPool.upstreamAccounts.oauth.authUrlPlaceholder': 'Generate the OAuth URL first.',
    'accountPool.upstreamAccounts.oauth.redirectUriLabel': 'Expected callback address',
    'accountPool.upstreamAccounts.oauth.redirectUriDescription': 'The sign-in browser should stop at this localhost address. Copy the full final URL from that browser after login.',
    'accountPool.upstreamAccounts.oauth.redirectUriPlaceholder': 'Generate the OAuth URL to get the localhost callback address.',
  ...
  zh: {
    ...
    'accountPool.upstreamAccounts.oauth.copyFailed': '复制失败了，请手动从文本框复制 OAuth 地址。',
    ...
    'accountPool.upstreamAccounts.oauth.authUrlLabel': 'OAuth 地址',
    'accountPool.upstreamAccounts.oauth.authUrlDescription': '把这个地址复制到目标浏览器中，不要在当前页面直接跳转。',
    'accountPool.upstreamAccounts.oauth.authUrlPlaceholder': '请先生成 OAuth 地址。',
    'accountPool.upstreamAccounts.oauth.redirectUriLabel': '预期回调地址',
    'accountPool.upstreamAccounts.oauth.redirectUriDescription': '登录浏览器会停在这个 localhost 地址。登录后把完整最终链接从那个浏览器复制出来。',
    'accountPool.upstreamAccounts.oauth.redirectUriPlaceholder': '生成 OAuth 地址后，这里会显示 localhost 回调地址。',
