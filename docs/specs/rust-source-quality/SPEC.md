...
The policy MUST keep the current inventory as 50 explicit file entries: 28
...
The current inventory retains no cohesive-module exceptions: all 50 entries have
...
Pass condition: the policy has 28 production and 22 test/helper entries, with
