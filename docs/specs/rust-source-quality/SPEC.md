...
The policy MUST keep the current inventory as 53 explicit file entries: 31
...
The current inventory retains no cohesive-module exceptions: all 53 entries have
...
Pass condition: the policy has 31 production and 22 test/helper entries, with
