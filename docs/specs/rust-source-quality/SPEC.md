...
The policy MUST keep the current inventory as 49 explicit file entries: 28
...
The current inventory retains no cohesive-module exceptions: all 49 entries have
...
Pass condition: the policy has 28 production and 21 test/helper entries, with
