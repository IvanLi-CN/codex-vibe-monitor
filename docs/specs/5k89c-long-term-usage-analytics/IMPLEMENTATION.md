...
- canonical interval 分批提交后，增量路径会按受影响上海日期从 durable canonical/legacy state 刷新 runtime union；日期重建先清理同日 canonical 与 legacy 行，避免取消、pressure 或迁移顺序把旧 wall-time 重新带回 rollup。
