...
- `NumericRangeField` 当前以双端 slider 为主交互，支持轨道直接调整最近端点、字段内当前区间摘要以及与错误状态绑定的可访问性语义；slider 上界使用 records summary 的真实数值域。
...
- 已更新 Storybook mock、Vitest、Rust query/suggestion tests，并产出 mock-only visual evidence。
