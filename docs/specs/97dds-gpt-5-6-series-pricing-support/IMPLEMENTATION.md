...
- Repair-batch source candidate `eabac2d5`, based on `cdb7fbfa85e460e5fa666aa66834c9fc52745b8e`, passed: `lightweight` (1,134 passed, 1,667 skipped), `stateful-sqlite` (1,339 passed, 1,462 skipped), `archive-file-io` (281 passed, 2,520 skipped), Rust fmt/check/Clippy/source-quality, and targeted Terra-variant and unsupported-tier refresh regressions. The repair preserves unsupported actual-tier unknown cost while retaining newly observed tier metadata.
