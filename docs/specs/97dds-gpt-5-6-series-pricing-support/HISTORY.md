...
- 2026-07-10: Deferred runtime UI exposure of derived cache write token counts to keep the boundary between operator-entered pricing metadata and upstream usage truth explicit.
