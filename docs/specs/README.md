...
| ----- | ----------------------------------------------------------------------------- | --------------- | -------------------------------------------------------- | ---------- | ------------------------------------------------------- |
| nm7ep | Daily timeseries archive continuity hotfix                                    | 进行中（2/3）   | `nm7ep-daily-timeseries-rollup-continuity/SPEC.md`       | 2026-03-11 | fast-track / hotfix / local validation passed           |
