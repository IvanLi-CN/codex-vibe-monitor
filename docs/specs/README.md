...
| ----- | ----------------------------------------------------------------------------- | --------------- | -------------------------------------------------------- | ---------- | ------------------------------------------------------- |
| 5gqdb | InvocationTable 桌面代理名省略回归热修                                        | 已完成          | `5gqdb-invocation-proxy-name-truncation-hotfix/SPEC.md`  | 2026-03-09 | fast-track / PR #105 / checks green / review-loop clear |
