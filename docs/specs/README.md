...
| quhzx | 建立全局 UI 规范文档体系 | 部分完成（4/5） | `quhzx-ui-guidelines-system/SPEC.md` | 2026-03-18 | docs-only / docs/ui / local validation green / fast-track |
| ----- | ----------------------------------------------------------------------------- | --------------- | -------------------------------------------------------- | ---------- | ---------------------------------------------------------------------------------------------- |
| r7o2q | OAuth 池账号 API Scope 与重授权误判修复 | 进行中 | `r7o2q-oauth-api-scope-reauth-hardening/SPEC.md` | 2026-03-16 | fast-track / oauth api scopes / route-failure hardening / old accounts need one reauth |
...
| g4ek6 | 号池模块第一阶段：上游账号管理 | 已实现 | `g4ek6-account-pool-upstream-accounts/SPEC.md` | 2026-03-16 | fast-track / PR #148 / team duplicate contract + plan-type observed-at freshness synced |
