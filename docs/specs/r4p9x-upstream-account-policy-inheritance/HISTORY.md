...
2026-09-08: PR #917 corrected API-key transit routing after production verification: automatic migration guarantees a non-empty account proxy binding, and runtime selection no longer consults legacy group proxy or policy state.
