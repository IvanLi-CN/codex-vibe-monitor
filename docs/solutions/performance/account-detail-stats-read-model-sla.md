...
- Legacy structured-account backfill updates at most 32 rows per transaction with a 200ms target. It rematerializes only affected hours containing at most 200 source rows; denser hours commit the additive assignment as a coverage hole and remain preparing until independent repair completes.
